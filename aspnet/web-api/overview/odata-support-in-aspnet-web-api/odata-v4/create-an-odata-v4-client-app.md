...
Hizmet proxy'si OData hizmetine erişmek için yöntemler tanımlayan bir .NET sınıfıdır. Proxy HTTP istek yöntemi çağrılarını çevirir. Proxy sınıfı çalıştırarak oluşturacak bir [T4 şablon](https://msdn.microsoft.com/en-us/library/bb126445.aspx).
