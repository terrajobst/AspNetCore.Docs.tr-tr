...
====================
> Web API barındırmak nasıl.


- [OWIN Web API 2 Self barındırmak için kullanın](use-owin-to-self-host-web-api.md)
- [Web API 2 Azure çalışan rolünde ana bilgisayar](host-aspnet-web-api-in-an-azure-worker-role.md)
