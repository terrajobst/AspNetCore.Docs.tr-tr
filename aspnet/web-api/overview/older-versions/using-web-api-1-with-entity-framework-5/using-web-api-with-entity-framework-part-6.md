...
- Biz sipariş için veritabanı sorguladığınızda kullanırız [DbQuery.Include](https://msdn.microsoft.com/en-us/library/gg696395) ilgili getirilemedi yöntemi `OrderDetail` ve `Product` varlıklar.
