...
İçinde belirli bir tarzını books listesini almak için istemci bir GET isteği gönderir `/api/books/genre`, burada *Tarz* Tarz adıdır. (Örneğin, `/get/books/fantasy`.)
