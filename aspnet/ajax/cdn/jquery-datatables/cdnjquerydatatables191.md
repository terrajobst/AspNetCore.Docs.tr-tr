...
ms.locfileid: "30071239"
---
<a name="jquery-datatables-191"></a><span data-ttu-id="0a929-102">jQuery DataTables 1.9.1</span><span class="sxs-lookup"><span data-stu-id="0a929-102">jQuery DataTables 1.9.1</span></span>
====================
<span data-ttu-id="0a929-103">Aşağıdaki dosyalar jQuery DataTables eklentileri için CDN üzerinde barındırılan:</span><span class="sxs-lookup"><span data-stu-id="0a929-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
