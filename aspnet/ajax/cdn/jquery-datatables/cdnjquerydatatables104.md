...
---
<a name="jquery-datatables-1104"></a><span data-ttu-id="6e5cb-102">jQuery DataTable 1.10.4</span><span class="sxs-lookup"><span data-stu-id="6e5cb-102">jQuery DataTables 1.10.4</span></span>
====================
<span data-ttu-id="6e5cb-103">Aşağıdaki dosyalar için jQuery DataTable eklentileri, CDN'de barındırılan:</span><span class="sxs-lookup"><span data-stu-id="6e5cb-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
