...
ms.locfileid: "37818184"
---
<a name="jquery-datatables-1105"></a><span data-ttu-id="dcf4f-102">jQuery DataTable 1.10.5</span><span class="sxs-lookup"><span data-stu-id="dcf4f-102">jQuery DataTables 1.10.5</span></span>
====================
<span data-ttu-id="dcf4f-103">Aşağıdaki dosyalar için jQuery DataTable eklentileri, CDN'de barındırılan:</span><span class="sxs-lookup"><span data-stu-id="dcf4f-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
