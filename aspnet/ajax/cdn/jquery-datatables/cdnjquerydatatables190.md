...
ms.locfileid: "37377146"
---
<a name="jquery-datatables-190"></a><span data-ttu-id="c4e8a-102">jQuery DataTable 1.9.0</span><span class="sxs-lookup"><span data-stu-id="c4e8a-102">jQuery DataTables 1.9.0</span></span>
====================
<span data-ttu-id="c4e8a-103">Aşağıdaki dosyalar için jQuery DataTable eklentileri, CDN'de barındırılan:</span><span class="sxs-lookup"><span data-stu-id="c4e8a-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
