...
ms.locfileid: "41753173"
---
<a name="jquery-datatables-190"></a><span data-ttu-id="72302-102">jQuery DataTable 1.9.0</span><span class="sxs-lookup"><span data-stu-id="72302-102">jQuery DataTables 1.9.0</span></span>
====================
<span data-ttu-id="72302-103">Aşağıdaki dosyalar için jQuery DataTable eklentileri, CDN'de barındırılan:</span><span class="sxs-lookup"><span data-stu-id="72302-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
