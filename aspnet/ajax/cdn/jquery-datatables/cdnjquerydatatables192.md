...
---
<a name="jquery-datatables-192"></a><span data-ttu-id="2c96f-102">jQuery DataTable 1.9.2</span><span class="sxs-lookup"><span data-stu-id="2c96f-102">jQuery DataTables 1.9.2</span></span>
====================
<span data-ttu-id="2c96f-103">Aşağıdaki dosyalar için jQuery DataTable eklentileri, CDN'de barındırılan:</span><span class="sxs-lookup"><span data-stu-id="2c96f-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
