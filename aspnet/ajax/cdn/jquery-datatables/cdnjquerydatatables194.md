...
ms.locfileid: "41755335"
---
<a name="jquery-datatables-194"></a><span data-ttu-id="6a5fa-102">jQuery DataTable 1.9.4</span><span class="sxs-lookup"><span data-stu-id="6a5fa-102">jQuery DataTables 1.9.4</span></span>
====================
<span data-ttu-id="6a5fa-103">Aşağıdaki dosyalar için jQuery DataTable eklentileri, CDN'de barındırılan:</span><span class="sxs-lookup"><span data-stu-id="6a5fa-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
