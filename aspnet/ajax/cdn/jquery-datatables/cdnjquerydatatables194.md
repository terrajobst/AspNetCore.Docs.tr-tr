...
ms.locfileid: "37364222"
---
<a name="jquery-datatables-194"></a><span data-ttu-id="7413b-102">jQuery DataTable 1.9.4</span><span class="sxs-lookup"><span data-stu-id="7413b-102">jQuery DataTables 1.9.4</span></span>
====================
<span data-ttu-id="7413b-103">Aşağıdaki dosyalar için jQuery DataTable eklentileri, CDN'de barındırılan:</span><span class="sxs-lookup"><span data-stu-id="7413b-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
