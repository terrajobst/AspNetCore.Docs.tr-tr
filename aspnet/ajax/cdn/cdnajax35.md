...
---
<a name="aspnet-ajax-35"></a><span data-ttu-id="29681-102">ASP.NET Ajax 3.5</span><span class="sxs-lookup"><span data-stu-id="29681-102">ASP.NET Ajax 3.5</span></span>
====================
<span data-ttu-id="29681-103">Aşağıdaki dosyalar, CDN'de barındırılan:</span><span class="sxs-lookup"><span data-stu-id="29681-103">The following files are hosted on the CDN:</span></span>
