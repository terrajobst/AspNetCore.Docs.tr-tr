...
ms.locfileid: "30078017"
---
<a name="jqueryvalidate-version-181"></a><span data-ttu-id="08188-102">JQuery.Validate sürüm 1.8.1</span><span class="sxs-lookup"><span data-stu-id="08188-102">jquery.validate version 1.8.1</span></span>
====================
<span data-ttu-id="08188-103">Aşağıdaki dosyalar üzerinde CDN barındırılan:</span><span class="sxs-lookup"><span data-stu-id="08188-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="08188-104">Yerelleştirme dosyaları adresindeki https://ajax.aspnetcdn.com/ajax/jquery.validate/1.8.1/localization/messages \_## .js burada ## loc kodudur.</span><span class="sxs-lookup"><span data-stu-id="08188-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.8.1/localization/messages\_##.js where ## is the loc code.</span></span>
