...
ms.locfileid: "30071963"
---
<a name="jquery-validation-1100"></a><span data-ttu-id="8db15-102">jQuery doğrulama 1.10.0</span><span class="sxs-lookup"><span data-stu-id="8db15-102">jQuery Validation 1.10.0</span></span>
====================
<span data-ttu-id="8db15-103">Aşağıdaki dosyalar üzerinde CDN barındırılan:</span><span class="sxs-lookup"><span data-stu-id="8db15-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="8db15-104">Yerelleştirme dosyaları adresindeki https://ajax.aspnetcdn.com/ajax/jquery.validate/1.10.0/localization/messages \_## .js burada ## loc kodudur.</span><span class="sxs-lookup"><span data-stu-id="8db15-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.10.0/localization/messages\_##.js where ## is the loc code.</span></span>
