...
ms.locfileid: "37836716"
---
<a name="jqueryvalidate-version-18"></a><span data-ttu-id="c4910-102">JQuery.Validate sürümü 1.8</span><span class="sxs-lookup"><span data-stu-id="c4910-102">jquery.validate version 1.8</span></span>
====================
<span data-ttu-id="c4910-103">Aşağıdaki dosyalar, CDN'de barındırılan:</span><span class="sxs-lookup"><span data-stu-id="c4910-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="c4910-104">Yerelleştirme dosyalarının https://ajax.aspnetcdn.com/ajax/jquery.validate/1.8/localization/messages\_##.js nerede ## loc kodudur.</span><span class="sxs-lookup"><span data-stu-id="c4910-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.8/localization/messages\_##.js where ## is the loc code.</span></span>
