...
ms.locfileid: "30071304"
---
<a name="jquery-validation-1130"></a><span data-ttu-id="ad3af-102">jQuery Validation 1.13.0</span><span class="sxs-lookup"><span data-stu-id="ad3af-102">jQuery Validation 1.13.0</span></span>
====================
<span data-ttu-id="ad3af-103">Aşağıdaki dosyalar üzerinde CDN barındırılan:</span><span class="sxs-lookup"><span data-stu-id="ad3af-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="ad3af-104">Yerelleştirme dosyaları adresindeki https://ajax.aspnetcdn.com/ajax/jquery.validate/1.13.0/localization/messages \_## .js burada ## loc kodudur.</span><span class="sxs-lookup"><span data-stu-id="ad3af-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.13.0/localization/messages\_##.js where ## is the loc code.</span></span>
