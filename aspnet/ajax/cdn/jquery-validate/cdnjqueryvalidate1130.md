...
ms.locfileid: "37816116"
---
<a name="jquery-validation-1130"></a><span data-ttu-id="d0f64-102">jQuery doğrulaması 1.13.0</span><span class="sxs-lookup"><span data-stu-id="d0f64-102">jQuery Validation 1.13.0</span></span>
====================
<span data-ttu-id="d0f64-103">Aşağıdaki dosyalar, CDN'de barındırılan:</span><span class="sxs-lookup"><span data-stu-id="d0f64-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="d0f64-104">Yerelleştirme dosyalarının https://ajax.aspnetcdn.com/ajax/jquery.validate/1.13.0/localization/messages\_##.js nerede ## loc kodudur.</span><span class="sxs-lookup"><span data-stu-id="d0f64-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.13.0/localization/messages\_##.js where ## is the loc code.</span></span>
