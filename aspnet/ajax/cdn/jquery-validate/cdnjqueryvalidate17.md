...
---
<a name="jqueryvalidate-version-17"></a><span data-ttu-id="ef9d1-102">JQuery.Validate sürüm 1.7</span><span class="sxs-lookup"><span data-stu-id="ef9d1-102">jquery.validate version 1.7</span></span>
====================
<span data-ttu-id="ef9d1-103">Aşağıdaki dosyalar üzerinde CDN barındırılan:</span><span class="sxs-lookup"><span data-stu-id="ef9d1-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="ef9d1-104">Yerelleştirme dosyaları</span><span class="sxs-lookup"><span data-stu-id="ef9d1-104">Localization Files</span></span>
