...
ms.locfileid: "41752787"
---
<a name="jquery-validation-1110"></a><span data-ttu-id="dccd6-102">jQuery doğrulaması 1.11.0</span><span class="sxs-lookup"><span data-stu-id="dccd6-102">jQuery Validation 1.11.0</span></span>
====================
<span data-ttu-id="dccd6-103">Aşağıdaki dosyalar, CDN'de barındırılan:</span><span class="sxs-lookup"><span data-stu-id="dccd6-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="dccd6-104">Yerelleştirme dosyalarının https://ajax.aspnetcdn.com/ajax/jquery.validate/1.11.0/localization/messages\_##.js nerede ## loc kodudur.</span><span class="sxs-lookup"><span data-stu-id="dccd6-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.11.0/localization/messages\_##.js where ## is the loc code.</span></span>
