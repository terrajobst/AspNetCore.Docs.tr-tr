...
---
<a name="jquery-validation-1170"></a><span data-ttu-id="678c2-102">jQuery doğrulaması 1.17.0</span><span class="sxs-lookup"><span data-stu-id="678c2-102">jQuery Validation 1.17.0</span></span>
====================
<span data-ttu-id="678c2-103">Aşağıdaki dosyalar, CDN'de barındırılan:</span><span class="sxs-lookup"><span data-stu-id="678c2-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="678c2-104">Yerelleştirme dosyalarının https://ajax.aspnetcdn.com/ajax/jquery.validate/1.17.0/localization/messages\_##.js nerede ## loc kodudur.</span><span class="sxs-lookup"><span data-stu-id="678c2-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.17.0/localization/messages\_##.js where ## is the loc code.</span></span>
