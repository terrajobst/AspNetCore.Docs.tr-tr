...
ms.locfileid: "37825486"
---
<a name="jquery-mobile-131-on-the-microsoft-ajax-cdn"></a><span data-ttu-id="411cd-102">Microsoft Ajax CDN üzerinde jQuery Mobile 1.3.1</span><span class="sxs-lookup"><span data-stu-id="411cd-102">jQuery Mobile 1.3.1 on the Microsoft Ajax CDN</span></span>
====================
<span data-ttu-id="411cd-103">JQuery Mobile 1.3.1 kitaplığı aşağıdaki dosyaları içerir:</span><span class="sxs-lookup"><span data-stu-id="411cd-103">The jQuery Mobile 1.3.1 library includes the following files:</span></span>
