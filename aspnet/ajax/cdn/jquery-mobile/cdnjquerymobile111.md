...
ms.locfileid: "37827469"
---
<a name="jquery-mobile-111-on-the-microsoft-ajax-cdn"></a><span data-ttu-id="a23c7-102">Microsoft Ajax CDN üzerinde jQuery Mobile 1.1.1</span><span class="sxs-lookup"><span data-stu-id="a23c7-102">jQuery Mobile 1.1.1 on the Microsoft Ajax CDN</span></span>
====================
<span data-ttu-id="a23c7-103">JQuery Mobile 1.1.1 kitaplığı aşağıdaki dosyaları içerir:</span><span class="sxs-lookup"><span data-stu-id="a23c7-103">The jQuery Mobile 1.1.1 library includes the following files:</span></span>
