...
---
<a name="jquery-mobile-141-on-the-microsoft-ajax-cdn"></a><span data-ttu-id="3d4bc-102">Microsoft Ajax CDN üzerinde jQuery Mobile 1.4.1</span><span class="sxs-lookup"><span data-stu-id="3d4bc-102">jQuery Mobile 1.4.1 on the Microsoft Ajax CDN</span></span>
====================
<span data-ttu-id="3d4bc-103">JQuery Mobile 1.4.1 kitaplığı aşağıdaki dosyaları içerir:</span><span class="sxs-lookup"><span data-stu-id="3d4bc-103">The jQuery Mobile 1.4.1 library includes the following files:</span></span>
