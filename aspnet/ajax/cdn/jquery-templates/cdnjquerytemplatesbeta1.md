...
ms.locfileid: "30078159"
---
<a name="jquery-templates-beta-1"></a><span data-ttu-id="07506-102">jQuery şablonları Beta 1</span><span class="sxs-lookup"><span data-stu-id="07506-102">jQuery Templates Beta 1</span></span>
====================
<span data-ttu-id="07506-103">JQuery şablonları eklentisi aşağıdaki dosyaları içerir:</span><span class="sxs-lookup"><span data-stu-id="07506-103">The jQuery Templates plugin includes the following files:</span></span>
