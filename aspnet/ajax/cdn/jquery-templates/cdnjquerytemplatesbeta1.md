...
ms.locfileid: "41753788"
---
<a name="jquery-templates-beta-1"></a><span data-ttu-id="f658c-102">jQuery şablonları Beta 1</span><span class="sxs-lookup"><span data-stu-id="f658c-102">jQuery Templates Beta 1</span></span>
====================
<span data-ttu-id="f658c-103">JQuery şablonları eklentisi aşağıdaki dosyaları içerir:</span><span class="sxs-lookup"><span data-stu-id="f658c-103">The jQuery Templates plugin includes the following files:</span></span>
