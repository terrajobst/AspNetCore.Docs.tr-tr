...
- [En iyi uygulamalar için Windows Azure bulut hizmetleri üzerinde büyük ölçekli hizmetler tasarımını](https://msdn.microsoft.com/en-us/library/windowsazure/jj717232.aspx). Teknik incelemesi işareti SIMM'lerinin ve Michael Thomassy tarafından.
- [Microsoft Patterns and Practices - tasarım desenleri bulut](https://msdn.microsoft.com/en-us/library/dn568099.aspx). Veri bölümlendirme Kılavuzu, parçalama düzeni bakın.
