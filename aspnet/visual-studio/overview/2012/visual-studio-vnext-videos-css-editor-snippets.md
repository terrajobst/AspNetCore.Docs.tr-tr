...
====================
<span data-ttu-id="95a4a-104">tarafından [Kristensen Mads](https://github.com/madskristensen)</span><span class="sxs-lookup"><span data-stu-id="95a4a-104">by [Mads Kristensen](https://github.com/madskristensen)</span></span>

<span data-ttu-id="95a4a-105">Bu videoda, bazı yararlı parçacıkları CSS3 dönüşümler, medya sorguları, yazı tipi katıştırma ve daha fazla bilgi için ekleyen Visual Studio vNext CSS Düzenleyicisi'nde bir geliştirme Mads Kristensen gösterir.</span><span class="sxs-lookup"><span data-stu-id="95a4a-105">In this video, Mads Kristensen demonstrates an improvement in the Visual Studio vNext CSS editor which adds some useful snippets for CSS3 transforms, media queries, font embedding, and more.</span></span>

[<span data-ttu-id="95a4a-106">&#9654; (1 dakika) videoyu izleyin</span><span class="sxs-lookup"><span data-stu-id="95a4a-106">&#9654; Watch video (1 minutes)</span></span>](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/visual-studio-vnext-videos-css-editor-snippets)
