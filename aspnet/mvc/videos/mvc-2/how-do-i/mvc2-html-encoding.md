...
---
<a name="mvc2---html-encoding"></a>MVC2 - Html kodlaması
====================
tarafından [Microsoft](https://github.com/microsoft)

Bu videoda, yeni HTML kodlaması kısayol sözdizimi ASP.NET komut dosyası ekleme karşı koruma sağlamak için ve HTML, dizelerde dahil etmek istediğiniz zaman MvcHtmlString kullanmak üzere nasıl kullanılacağını öğreneceksiniz.

[&#9654;(2 dakika olarak) videoyu izleyin](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/mvc2-html-encoding)
