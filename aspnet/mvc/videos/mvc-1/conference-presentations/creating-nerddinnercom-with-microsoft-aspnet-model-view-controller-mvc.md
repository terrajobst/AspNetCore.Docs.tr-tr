...
Slayt yok. Yalnızca kodu. Dosya-yeni ile başlamalı ve ASP.NET, ASP.NET AJAX, kimlik doğrulama, yetkilendirme, MVC, Microsoft SQL Server ve jQuery gerçek bir Web sitesiyle derleme altmış beş dakika veya daha az.

[&#9654; (71 dakika) videoyu izleyin](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/creating-nerddinnercom-with-microsoft-aspnet-model-view-controller-mvc)
