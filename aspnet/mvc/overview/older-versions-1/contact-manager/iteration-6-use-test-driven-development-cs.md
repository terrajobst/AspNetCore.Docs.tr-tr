...
**Şekil 06**: varlık grubu ve ilgili kişi görüntüleme Tasarımcısı ([tam boyutlu görüntüyü görmek için tıklatın](iteration-6-use-test-driven-development-cs/_static/image12.png))
...
**Şekil 07**: grubu dizini görünümü ([tam boyutlu görüntüyü görmek için tıklatın](iteration-6-use-test-driven-development-cs/_static/image14.png))
