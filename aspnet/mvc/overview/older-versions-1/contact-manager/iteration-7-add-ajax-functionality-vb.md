...
[Kodu indirme](iteration-7-add-ajax-functionality-vb/_static/contactmanager_7_vb1.zip)
...
[![Yalnızca Kişiler güncelleştiriliyor](iteration-7-add-ajax-functionality-vb/_static/image1.jpg)](iteration-7-add-ajax-functionality-vb/_static/image1.png)

**Şekil 01**: yalnızca Kişiler güncelleştirme ([tam boyutlu görüntüyü görüntülemek için tıklatın](iteration-7-add-ajax-functionality-vb/_static/image2.png))
...
**3 - Controllers\ContactController.vb (dizin yöntemi) listeleme**
...
**Şekil 02**: silme onayı sayfası ([tam boyutlu görüntüyü görüntülemek için tıklatın](iteration-7-add-ajax-functionality-vb/_static/image4.png))
...
**7 - Controllers\ContactController.vb (AjaxDelete) listeleme**   
