...
[Kodu indirme](iteration-1-create-the-application-cs/_static/contactmanager_1_cs1.zip)
...
**Şekil 01**: Yeni Proje iletişim kutusu ([tam boyutlu görüntüyü görüntülemek için tıklatın](iteration-1-create-the-application-cs/_static/image2.png))
...
**Şekil 02**: birim testi projesi oluştur iletişim kutusu ([tam boyutlu görüntüyü görüntülemek için tıklatın](iteration-1-create-the-application-cs/_static/image4.png))
...
**Şekil 03**: Solution Explorer penceresi ([tam boyutlu görüntüyü görüntülemek için tıklatın](iteration-1-create-the-application-cs/_static/image6.png))
...
**Şekil 04**: yeni bir Microsoft SQL Server Express veritabanı oluşturma ([tam boyutlu görüntüyü görüntülemek için tıklatın](iteration-1-create-the-application-cs/_static/image8.png))
...
**Şekil 05**: veritabanı Tablo Tasarımcısı'nda ([tam boyutlu görüntüyü görüntülemek için tıklatın](iteration-1-create-the-application-cs/_static/image10.png))
...
**Şekil 06**: Yeni Öğe Ekle iletişim kutusu ([tam boyutlu görüntüyü görüntülemek için tıklatın](iteration-1-create-the-application-cs/_static/image12.png))
...
**Şekil 07**: Model içeriği seçin ([tam boyutlu görüntüyü görüntülemek için tıklatın](iteration-1-create-the-application-cs/_static/image14.png))
...
**Şekil 08**: veri bağlantınızı seçin ([tam boyutlu görüntüyü görüntülemek için tıklatın](iteration-1-create-the-application-cs/_static/image16.png))
...
**Şekil 09**: veritabanı nesnelerinizi ([tam boyutlu görüntüyü görüntülemek için tıklatın](iteration-1-create-the-application-cs/_static/image18.png))
...
**Şekil 10**: kişi sınıfı ([tam boyutlu görüntüyü görüntülemek için tıklatın](iteration-1-create-the-application-cs/_static/image20.png))
...
**Şekil 11**: Giriş denetleyicisi ekleme ([tam boyutlu görüntüyü görüntülemek için tıklatın](iteration-1-create-the-application-cs/_static/image22.png))
...
**Şekil 12**: dizini görünümü ekleme ([tam boyutlu görüntüyü görüntülemek için tıklatın](iteration-1-create-the-application-cs/_static/image24.png))


İçinde **Görünüm Ekle** iletişim kutusunda, etiketli onay kutusunu işaretleyin **kesin türü belirtilmiş görünüm oluşturmak**. Görünüm veri sınıfı ContactManager.Models.Contact ve Görünüm İçerik listesini seçin. Bu seçenekleri kişi kayıtların listesini görüntüleyen bir görünüm oluşturur.
...
**Şekil 13**: Görünüm Ekle iletişim kutusu ([tam boyutlu görüntüyü görüntülemek için tıklatın](iteration-1-create-the-application-cs/_static/image26.png))
...
**Şekil 14**: hata ayıklamasını etkinleştirme ([tam boyutlu görüntüyü görüntülemek için tıklatın](iteration-1-create-the-application-cs/_static/image28.png))
...
**Şekil 15**: dizin görünümünün ([tam boyutlu görüntüyü görüntülemek için tıklatın](iteration-1-create-the-application-cs/_static/image30.png))
...
**4 - Controllers\HomeController.cs (yöntemleriyle Oluştur) listeleme**
...
**Şekil 16**: oluşturma görünümü ekleme ([tam boyutlu görüntüyü görüntülemek için tıklatın](iteration-1-create-the-application-cs/_static/image32.png))


İçinde **Görünüm Ekle** iletişim kutusunda **ContactManager.Models.Contact** sınıfı ve **oluşturma** içeriği görüntüle seçeneğini (Şekil 17 bakın). Tıkladığınızda **Ekle** button, Görünüm otomatik olarak oluşturulan bir oluşturun.
...
**Şekil 17**: açılımı bir sayfayı görmenizin ([tam boyutlu görüntüyü görüntülemek için tıklatın](iteration-1-create-the-application-cs/_static/image34.png))
...
**Şekil 18**: Görünüm Oluştur ([tam boyutlu görüntüyü görüntülemek için tıklatın](iteration-1-create-the-application-cs/_static/image36.png))
...
**6 - Controllers\HomeController.cs (yöntemleriyle Düzenle) listeleme**
...
**Şekil 19**: düzenleme görünümü ekleme ([tam boyutlu görüntüyü görüntülemek için tıklatın](iteration-1-create-the-application-cs/_static/image38.png))
...
**8 - Controllers\HomeController.cs (Delete yöntemleri) listeleme**
...
**Şekil 20**: silme onayı Görünüm ([tam boyutlu görüntüyü görüntülemek için tıklatın](iteration-1-create-the-application-cs/_static/image40.png))
...
**Şekil 21**: dizin düzenleme bağlantısını görünümüyle ([tam boyutlu görüntüyü görüntülemek için tıklatın](iteration-1-create-the-application-cs/_static/image42.png))
...
**Şekil 22**: silme onayı görünümü ekleme ([tam boyutlu görüntüyü görüntülemek için tıklatın](iteration-1-create-the-application-cs/_static/image44.png))
...
Bu sorunu gidermek kolay. İlk olarak, biz giriş denetleyicinin adı yeniden düzenlemeniz gerekir. HomeController sınıfı Visual Studio Kod düzenleyicisinde açın, sınıfın adını sağ tıklatın ve menü seçeneğini **yeniden düzenlemeniz, yeniden adlandırma**. Bu menü seçeneğini seçerek yeniden adlandır iletişim kutusunu açar.
...
**Şekil 23**: bir denetleyici adı yeniden düzenleme ([tam boyutlu görüntüyü görüntülemek için tıklatın](iteration-1-create-the-application-cs/_static/image46.png))
...
**Şekil 24**: yeniden adlandır iletişim kutusu kullanılarak ([tam boyutlu görüntüyü görüntülemek için tıklatın](iteration-1-create-the-application-cs/_static/image48.png))
...
**Şekil 25**: varsayılan denetleyicisi yok ([tam boyutlu görüntüyü görüntülemek için tıklatın](iteration-1-create-the-application-cs/_static/image50.png))
