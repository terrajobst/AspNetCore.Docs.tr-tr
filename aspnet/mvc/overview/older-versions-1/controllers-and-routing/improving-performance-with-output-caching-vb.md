...
Varsayılan olarak kullandığınızda, &lt;OutputCache&gt; üç konumda özniteliği, içerik önbelleğe alınmış: web sunucusu, herhangi bir proxy sunucusu ve web tarayıcısı. Tam olarak burada içerik konum özelliğini değiştirerek önbelleğe denetleyebilirsiniz &lt;OutputCache&gt; özniteliği.
...
Dikkat &lt;OutputCache&gt; listeleme 4 özniteliğinde OutputCacheLocation.Client değerine ayarlanmış bir konum özelliği içerir. &lt;OutputCache&gt; özniteliği NoStore özelliği de içerir. NoStore özelliği, proxy sunucuları ve tarayıcılar önbelleğe alınmış içeriği kalıcı bir kopyasını depolanmamalıdır bildirmek için kullanılır.
...
Bu sorunu VaryByParam özelliğinin yararlanarak düzeltebilirsiniz &lt;OutputCache&gt; özniteliği. Bu özellik, bir form parametre çok aynı içeriği önbelleğe alınmış farklı sürümlerini oluşturmanıza olanak sağlar veya sorgu dizesi parametresi değişir.
...
Çıktı önbelleği özelliklerini özelliklerini değiştirerek yapılandırma alternatif olarak &lt;OutputCache&gt; özniteliği, web (web.config) yapılandırma dosyasında bir önbellek profili oluşturabilirsiniz. Web yapılandırma dosyasında bir önbellek profili oluşturma birkaç önemli avantajlar sunar.
...
Nasıl bir denetleyici eylemi ile Cache1Hour profili uygulayabilirsiniz listeleme 7 denetleyicisi gösterilmektedir &lt;OutputCache&gt; özniteliği.

**7 – Controllers\ProfileController.vb listeleme**
