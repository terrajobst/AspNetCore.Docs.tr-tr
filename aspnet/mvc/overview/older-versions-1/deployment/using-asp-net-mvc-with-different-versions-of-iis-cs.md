...
**Şekil 1**: istek işleme modunu algılama ([tam boyutlu görüntüyü görüntülemek için tıklatın](using-asp-net-mvc-with-different-versions-of-iis-cs/_static/image2.png))
...
**Şekil 2**: 404 bulunamadı hatası alma ([tam boyutlu görüntüyü görüntülemek için tıklatın](using-asp-net-mvc-with-different-versions-of-iis-cs/_static/image4.png))
...
**Önemli**: Global.asax dosyası değiştirdikten sonra ASP.NET MVC uygulamanızı oluşturmak unutmayın.
...
**Şekil 3**: IIS 7. 0'ile bir joker karakter betik eşlemesi oluşturma ([tam boyutlu görüntüyü görüntülemek için tıklatın](using-asp-net-mvc-with-different-versions-of-iis-cs/_static/image6.png))
...
**Şekil 4**: IIS 6.0 ile bir joker karakter betik eşlemesi oluşturma ([tam boyutlu görüntüyü görüntülemek için tıklatın](using-asp-net-mvc-with-different-versions-of-iis-cs/_static/image8.png))
...
**Şekil 5**: eksik kök yolu hata ([tam boyutlu görüntüyü görüntülemek için tıklatın](using-asp-net-mvc-with-different-versions-of-iis-cs/_static/image10.png))
