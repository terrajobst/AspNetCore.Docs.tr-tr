...
ms.locfileid: "26564603"
---
<a name="understanding-models-views-and-controllers-vb"></a>Anlama modeller, görünümler ve denetleyiciler (VB)
====================
...
**Şekil 01**: Yeni Proje iletişim kutusu ([tam boyutlu görüntüyü görüntülemek için tıklatın](understanding-models-views-and-controllers-vb/_static/image2.png))
...
**Şekil 02**: birim testi iletişim kutusu oluşturma ([tam boyutlu görüntüyü görüntülemek için tıklatın](understanding-models-views-and-controllers-vb/_static/image4.png))
...
Denetleyicileri klasörünü genişletin, AccountController.vb adlı bir dosya ve HomeController.vb adlı bir dosya görmeniz gerekir. Görünümleri klasörünü genişletin, hesap, giriş ve paylaşılan adlı üç alt klasörler görmeniz gerekir. Giriş klasörünü genişletin About.aspx ve Index.aspx (bkz: Şekil 3) adlı iki ek dosyaları görürsünüz. Bu dosyalar varsayılan ASP.NET MVC şablonu dahil örnek uygulaması oluşturur.
...
**Şekil 03**: Çözüm Gezgini penceresi ([tam boyutlu görüntüyü görüntülemek için tıklatın](understanding-models-views-and-controllers-vb/_static/image6.png))
...
[![Hata ayıklama etkin iletişim kutusu](understanding-models-views-and-controllers-vb/_static/image4.jpg)](understanding-models-views-and-controllers-vb/_static/image7.png)

**Şekil 04**: hata ayıklama etkin iletişim ([tam boyutlu görüntüyü görüntülemek için tıklatın](understanding-models-views-and-controllers-vb/_static/image8.png))
...
**Şekil 05**: dizin sayfası ([tam boyutlu görüntüyü görüntülemek için tıklatın](understanding-models-views-and-controllers-vb/_static/image10.png))
...
Yalnızca bir sınıfı (örneğin, bir Visual Basic veya C# sınıfı) denetleyicisidir. ASP.NET MVC uygulaması örnek denetleyicileri klasöründe HomeController.vb adlı bir denetleyicisi içerir. HomeController.vb dosyasının içeriğini listeleme 2'de yeniden oluşturulur.
