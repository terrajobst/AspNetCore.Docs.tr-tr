...
---
<a name="displaying-a-table-of-database-data-vb"></a>(VB) veritabanı verilerinin tablosunu görüntüleme
====================
...
**Şekil 01**: LINQ to SQL sınıfları oluşturma ([tam boyutlu görüntüyü görmek için tıklatın](displaying-a-table-of-database-data-vb/_static/image2.png))
...
**Şekil 03**: denetleyicisi menü Ekle ([tam boyutlu görüntüyü görmek için tıklatın](displaying-a-table-of-database-data-vb/_static/image6.png))
