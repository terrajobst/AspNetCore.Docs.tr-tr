...
---
<a name="validating-with-the-idataerrorinfo-interface-vb"></a>IDataErrorInfo arabirimi (VB) ile doğrulama
====================
...
**Şekil 01**: film varlık ([tam boyutlu görüntüyü görüntülemek için tıklatın](validating-with-the-idataerrorinfo-interface-vb/_static/image2.png))
...
Film sınıf Entity Framework tarafından oluşturulur. Çözüm Gezgini penceresinde MoviesDBModel.edmx dosyasını genişletin ve kod düzenleyicisinde MoviesDBModel.Designer.vb dosyasını açın, film sınıfı için kod görebilirsiniz (bkz: Şekil 2).
...
**Şekil 02**: film varlık için kod ([tam boyutlu görüntüyü görüntülemek için tıklatın](validating-with-the-idataerrorinfo-interface-vb/_static/image4.png))
...
**4 - Models\Movie.vb (IDataErrorInfo uygulayan) listeleme**
...
[![Eylem yöntemleri otomatik olarak oluşturma](validating-with-the-idataerrorinfo-interface-vb/_static/image3.jpg)](validating-with-the-idataerrorinfo-interface-vb/_static/image5.png)

**Şekil 03**: eksik değerleri bir formla ([tam boyutlu görüntüyü görüntülemek için tıklatın](validating-with-the-idataerrorinfo-interface-vb/_static/image6.png))
...
> [sonraki](validating-with-a-service-layer-vb.md)
