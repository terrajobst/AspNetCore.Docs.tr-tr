...
---
<a name="validation-with-the-data-annotation-validators-vb"></a>(VB) veri ek açıklama doğrulayıcıları ile doğrulama
====================
...
**Şekil 6**: doğrulayıcıları ile Entity Framework kullanarak ([tam boyutlu görüntüyü görmek için tıklatın](validation-with-the-data-annotation-validators-vb/_static/image14.png))
