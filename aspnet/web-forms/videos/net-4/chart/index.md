...
====================
> Bu video serisini ASP.NET grafik denetiminin görsel olarak ilgi çekici veri görüntüsü oluşturmak için nasıl kullanılacağını gösterir.


- [Grafik Denetimi](aspnet-4-quick-hit-chart-control.md)
- [Visual Studio 2010'daki yeni grafik denetimi Tanıtımı](aspnet-4-how-do-i-introducing-the-new-chart-control-in-visual-studio-2010.md)
