...
---
<a name="how-do-i-use-the-aspnet-cache-object-to-cache-application-information"></a><span data-ttu-id="fd625-104">[Nasıl yedeklerim]: uygulama bilgilerini önbelleğe almak için ASP.NET önbellek nesnesi kullanma</span><span class="sxs-lookup"><span data-stu-id="fd625-104">[How Do I]: Use the ASP.NET Cache Object to Cache Application Information</span></span>
====================
