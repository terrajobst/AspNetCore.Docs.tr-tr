...
ms.locfileid: "41754000"
---
<a name="updating-the-tableadapter-to-use-joins-vb"></a>TableAdapter'ı kullanacak biçimde güncelleştirme (VB) birleştirir
====================
...
**Şekil 1**: bir ana sorgusu bu içerir girin `JOIN` s ([tam boyutlu görüntüyü görmek için tıklatın](updating-the-tableadapter-to-use-joins-vb/_static/image3.png))
...
**Şekil 5**: Select oluştur Yeni saklı yordamlar seçeneği ([tam boyutlu görüntüyü görmek için tıklatın](updating-the-tableadapter-to-use-joins-vb/_static/image11.png))
...
**Şekil 8**: TableAdapter içerir ekleme, güncelleştirme ve silme özelliklerini ([tam boyutlu görüntüyü görmek için tıklatın](updating-the-tableadapter-to-use-joins-vb/_static/image20.png))
...
**Şekil 11**: `EmployeesDataTable` içeren iki yeni sütun ([tam boyutlu görüntüyü görmek için tıklatın](updating-the-tableadapter-to-use-joins-vb/_static/image29.png))
...
**Şekil 14**: `JOIN` içinde `Employees_Select` saklı yordam adı s Manager döndürür ([tam boyutlu görüntüyü görmek için tıklatın](updating-the-tableadapter-to-use-joins-vb/_static/image38.png))
...
**Şekil 15**: yabancı anahtar kısıtlaması ihlali ile ilgili Siparişler sonuçları olan bir çalışanın siliniyor ([tam boyutlu görüntüyü görmek için tıklatın](updating-the-tableadapter-to-use-joins-vb/_static/image41.png))
