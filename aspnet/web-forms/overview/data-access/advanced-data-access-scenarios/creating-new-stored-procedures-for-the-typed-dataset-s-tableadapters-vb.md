...
ms.locfileid: "41754049"
---
<a name="creating-new-stored-procedures-for-the-typed-datasets-tableadapters-vb"></a>Yeni saklı yordam oluşturma türü belirtilmiş DataSet'in TableAdapter'ları için (VB)
====================
...
**Şekil 10**: yöntemleri ad `Fill` ve `GetProducts` ([tam boyutlu görüntüyü görmek için tıklatın](creating-new-stored-procedures-for-the-typed-dataset-s-tableadapters-vb/_static/image22.png))
...
**Şekil 11**: DataSet s Tasarımcısı gösteren yeni eklenen `ProductsDataTable` ([tam boyutlu görüntüyü görmek için tıklatın](creating-new-stored-procedures-for-the-typed-dataset-s-tableadapters-vb/_static/image25.png))
...
**Şekil 17**: oluşturma, yeni bir saklı yordam seçeneği seçin ([tam boyutlu görüntüyü görmek için tıklatın](creating-new-stored-procedures-for-the-typed-dataset-s-tableadapters-vb/_static/image37.png))
...
**Şekil 20**: yeni bir saklı yordam adı `Products_SelectByProductID` ([tam boyutlu görüntüyü görmek için tıklatın](creating-new-stored-procedures-for-the-typed-dataset-s-tableadapters-vb/_static/image46.png))
...
**Şekil 23**: GridView düzenleme ve silme desteği etkin sayfa içeriyor ([tam boyutlu görüntüyü görmek için tıklatın](creating-new-stored-procedures-for-the-typed-dataset-s-tableadapters-vb/_static/image55.png))
...
**Şekil 24**: ürünler görüntülenebilir, düzenlenen ve Silinen GridView gelen ([tam boyutlu görüntüyü görmek için tıklatın](creating-new-stored-procedures-for-the-typed-dataset-s-tableadapters-vb/_static/image58.png))
