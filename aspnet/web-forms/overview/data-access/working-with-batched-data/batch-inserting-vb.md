...
## <a name="step-1-creating-the-display-interface"></a>1. adım: ekran arabirimi oluşturma
...
**Şekil 2**: bir panelin tasarımcı araç kutusundan sürükleyin ([tam boyutlu görüntüyü görmek için tıklatın](batch-inserting-vb/_static/image6.png))
...
**Şekil 6**: ekleme arabirimi oluşur, bir dört sütunlu, satır içi yedi tablo ([tam boyutlu görüntüyü görmek için tıklatın](batch-inserting-vb/_static/image18.png))
...
**Şekil 11**: yerde `StatusLabel` denetim Yukarıdaki iki Panel denetimleri ([tam boyutlu görüntüyü görmek için tıklatın](batch-inserting-vb/_static/image33.png))


## <a name="step-3-switching-between-the-display-and-inserting-interfaces"></a>3. adım: ekran ve ekleme arabirimleri arasında geçiş yapma
...
**Şekil 12**: arabirim ekleme işlemi ürün sevk düğmesine Tıklandıktan sonra görüntülenir ([tam boyutlu görüntüyü görmek için tıklatın](batch-inserting-vb/_static/image36.png))
...
**Şekil 13**: bir ürün adı olan gerekli olduğunda girerek bir birim fiyatı ([tam boyutlu görüntüyü görmek için tıklatın](batch-inserting-vb/_static/image39.png))
