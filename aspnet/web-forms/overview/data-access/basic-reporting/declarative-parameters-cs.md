...
**Şekil 1**: bir ObjectDataSource sayfaya ekleyin ([tam boyutlu görüntüyü görmek için tıklatın](declarative-parameters-cs/_static/image3.png))
...
**Şekil 4**: A Hard-Coded parametre değeri, 5 için kullanılacak `productID` parametre ([tam boyutlu görüntüyü görmek için tıklatın](declarative-parameters-cs/_static/image12.png))
...
**Şekil 6**: sayfası bir metin kutusu ekleme `ID` `CountryName` ([tam boyutlu görüntüyü görmek için tıklatın](declarative-parameters-cs/_static/image18.png))
...
**Şekil 9**: Bu Kanada sağlayıcıdan gösterilir ([tam boyutlu görüntüyü görmek için tıklatın](declarative-parameters-cs/_static/image27.png))
...
**Şekil 10**: tüm tedarikçilerin olduğunu artık varsayılan olarak gösterilen ([tam boyutlu görüntüyü görmek için tıklatın](declarative-parameters-cs/_static/image30.png))
