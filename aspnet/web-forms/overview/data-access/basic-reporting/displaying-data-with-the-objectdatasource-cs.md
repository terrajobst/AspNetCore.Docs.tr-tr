...
ms.locfileid: "37814931"
---
<a name="displaying-data-with-the-objectdatasource-c"></a>(C#) ObjectDataSource ile verileri görüntüleme
====================
...
**Şekil 2**: Proxy olarak hizmet veren ObjectDataSource ([tam boyutlu görüntüyü görmek için tıklatın](displaying-data-with-the-objectdatasource-cs/_static/image4.png))
...
**Şekil 6**: A GridView eklendi ObjectDataSource bağlanan ve sayfa ([tam boyutlu görüntüyü görmek için tıklatın](displaying-data-with-the-objectdatasource-cs/_static/image16.png))
...
**Şekil 10**: Visual Studio oluşturma izin `App_Theme` klasörü ([tam boyutlu görüntüyü görmek için tıklatın](displaying-data-with-the-objectdatasource-cs/_static/image28.png))
...
**Şekil 15**: disk belleği etkinleştirme DetailsView denetiminde ([tam boyutlu görüntüyü görmek için tıklatın](displaying-data-with-the-objectdatasource-cs/_static/image41.png))
...
**Şekil 18**: ilk ürün (Chai), bir özel biçiminde görüntülenir ([tam boyutlu görüntüyü görmek için tıklatın](displaying-data-with-the-objectdatasource-cs/_static/image50.png))
