...
**Şekil 3**: her ürün s adı, tedarikçi ve kategori görüntülenir ([tam boyutlu görüntüyü görmek için tıklatın](sorting-data-in-a-datalist-or-repeater-control-vb/_static/image9.png))
...
**Şekil 4**: ürünleri ters alfabetik düzende kendi adına göre sıralanır ([tam boyutlu görüntüyü görmek için tıklatın](sorting-data-in-a-datalist-or-repeater-control-vb/_static/image12.png))
...
**Şekil 6**: olan ürünler başlangıçta kendi adına göre sıralanır ([tam boyutlu görüntüyü görmek için tıklatın](sorting-data-in-a-datalist-or-repeater-control-vb/_static/image16.png))
...
**Şekil 7**: olan ürünler artık sıralanmış kategoriye göre ([tam boyutlu görüntüyü görmek için tıklatın](sorting-data-in-a-datalist-or-repeater-control-vb/_static/image19.png))
...
**Şekil 9**: varsayılan olarak, sonuçları tarafından sıralanır `ProductName` ([tam boyutlu görüntüyü görmek için tıklatın](sorting-data-in-a-datalist-or-repeater-control-vb/_static/image25.png))
...
**Şekil 11**: sıralama ifadesi olan anımsanacak sayfalama aracılığıyla verilerinin ([tam boyutlu görüntüyü görmek için tıklatın](sorting-data-in-a-datalist-or-repeater-control-vb/_static/image31.png))
...
**Şekil 14**: ilk beş kayıt görüntülenir ([tam boyutlu görüntüyü görmek için tıklatın](sorting-data-in-a-datalist-or-repeater-control-vb/_static/image40.png))
...
**Şekil 15**: önceki ve son düğmeleri devre dışı bırakıldı, ilk sayfa ürünleri görüntülerken ([tam boyutlu görüntüyü görmek için tıklatın](sorting-data-in-a-datalist-or-repeater-control-vb/_static/image43.png))
...
**Şekil 16**: İkinci sayfa olan olan ürünler Dispalyed ([tam boyutlu görüntüyü görmek için tıklatın](sorting-data-in-a-datalist-or-repeater-control-vb/_static/image46.png))
