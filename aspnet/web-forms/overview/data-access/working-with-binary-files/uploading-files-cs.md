...
ms.locfileid: "37820081"
---
<a name="uploading-files-c"></a>Dosya Yükleme (C#)
====================
...
**Şekil 4**: ikili veriler, dosya sisteminde veya doğrudan veritabanında depolanabilir ([tam boyutlu görüntüyü görmek için tıklatın](uploading-files-cs/_static/image4.png))
...
**Şekil 9**: Sorgu kategorileri tablosundan seçin satır döndüren seçin bir kaydı döndürür bu yana ([tam boyutlu görüntüyü görmek için tıklatın](uploading-files-cs/_static/image14.png))
...
**Şekil 13**: kullanıcının bir dosya yüklemek için sunucu bilgisayarlarına seçebilirsiniz ([tam boyutlu görüntüyü görmek için tıklatın](uploading-files-cs/_static/image20.png))
