...
**Şekil 14**: çalışanın `HiredDate` Takvim denetiminde gösterilen ([tam boyutlu görüntüyü görüntülemek için tıklatın](using-templatefields-in-the-gridview-control-vb/_static/image42.png))
