...
ms.locfileid: "37814801"
---
<a name="adding-a-gridview-column-of-checkboxes-c"></a>Onay kutularından (C#) oluşan GridView sütunu ekleme
====================
...
**Şekil 8**: zaman Sil Seçili ürünleri düğmesine tıklandığında ürün seçildi `ProductID` s listelenir ([tam boyutlu görüntüyü görmek için tıklatın](adding-a-gridview-column-of-checkboxes-cs/_static/image16.png))
...
**Şekil 9**: denetleyin tüm düğmesini seçer tüm onay kutularını tıklayarak ([tam boyutlu görüntüyü görmek için tıklatın](adding-a-gridview-column-of-checkboxes-cs/_static/image18.png))
