...
ms.locfileid: "41754916"
---
<a name="inserting-a-new-record-from-the-gridviews-footer-c"></a>GridView'ın alt bilgisinden (C#) yeni kayıt ekleme
====================
...
**Şekil 1**: alt bilgi satır, yeni ürün eklemek için bir arabirim sağlar ([tam boyutlu görüntüyü görmek için tıklatın](inserting-a-new-record-from-the-gridview-s-footer-cs/_static/image2.png))
...
**Şekil 3**: eşleme `AddProduct` ObjectDataSource s yöntemi `Insert()` yöntemi ([tam boyutlu görüntüyü görmek için tıklatın](inserting-a-new-record-from-the-gridview-s-footer-cs/_static/image6.png))
...
**Şekil 6**: alt bilgi satır görüntülenecek kümesi `ShowFooter` için `True` ([tam boyutlu görüntüyü görmek için tıklatın](inserting-a-new-record-from-the-gridview-s-footer-cs/_static/image12.png))
...
**Şekil 7**: Boş altbilgi satırdır görüntülenen yukarıda sayfalama arabirimi denetimleri ([tam boyutlu görüntüyü görmek için tıklatın](inserting-a-new-record-from-the-gridview-s-footer-cs/_static/image14.png))
...
**Şekil 9**: s her alan uygun ekleme arabirimi ekleyin `FooterTemplate` ([tam boyutlu görüntüyü görmek için tıklatın](inserting-a-new-record-from-the-gridview-s-footer-cs/_static/image16.png))
...
**Şekil 12**: Düğme Ekle geri gönderme s'dir kısa Circuited ekleme arabiriminde geçersiz veri varsa ([tam boyutlu görüntüyü görmek için tıklatın](inserting-a-new-record-from-the-gridview-s-footer-cs/_static/image22.png))
