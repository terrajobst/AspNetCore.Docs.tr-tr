...
ms.locfileid: "37366922"
---
<a name="adding-a-gridview-column-of-radio-buttons-c"></a>(C#) radyo düğmelerinden oluşan GridView sütunu ekleme
====================
...
**Şekil 8**: kullanım ABD için varsayılan değer olarak `country` parametre ([tam boyutlu görüntüyü görmek için tıklatın](adding-a-gridview-column-of-radio-buttons-cs/_static/image12.png))
...
**Şekil 11**: GridView s radyo düğmeleri gruplanır değil ([tam boyutlu görüntüyü görmek için tıklatın](adding-a-gridview-column-of-radio-buttons-cs/_static/image18.png))
...
**Şekil 12**: bir sabit değer denetimine ekleme `ItemTemplate` ([tam boyutlu görüntüyü görmek için tıklatın](adding-a-gridview-column-of-radio-buttons-cs/_static/image20.png))
...
**Şekil 19**: SelectedValue GridView s parametre kaynağını belirtmek için bir ControlParameter'da kullanın ([tam boyutlu görüntüyü görmek için tıklatın](adding-a-gridview-column-of-radio-buttons-cs/_static/image34.png))
