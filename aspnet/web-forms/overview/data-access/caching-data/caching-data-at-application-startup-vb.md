...
ms.locfileid: "37841389"
---
<a name="caching-data-at-application-startup-vb"></a>(VB) uygulama başlangıcında verileri önbelleğe alma
====================
...
**Şekil 5**: kullanılacak ObjectDataSource yapılandırma `StaticCache` sınıfı ([tam boyutlu görüntüyü görmek için tıklatın](caching-data-at-application-startup-vb/_static/image11.png))
...
**Şekil 7**: Tedarikçi verileri önbelleğe içinde GridView görüntülenir ([tam boyutlu görüntüyü görmek için tıklatın](caching-data-at-application-startup-vb/_static/image17.png))
