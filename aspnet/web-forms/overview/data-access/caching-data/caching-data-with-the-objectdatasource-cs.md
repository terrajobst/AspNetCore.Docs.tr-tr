...
ms.locfileid: "37803051"
---
<a name="caching-data-with-the-objectdatasource-c"></a>(C#) ObjectDataSource ile verileri önbelleğe alma
====================
...
[![Şekil 2: SectionLevelTutorialListing.ascx kullanıcı denetimi için Default.aspx ekleyin.](caching-data-with-the-objectdatasource-cs/_static/image3.png)](caching-data-with-the-objectdatasource-cs/_static/image2.png)
...
**Şekil 5**: UPDATE sekmesi s açılır listede uygun ayarlamak `UpdateProduct` aşırı yükleme ([tam boyutlu görüntüyü görmek için tıklatın](caching-data-with-the-objectdatasource-cs/_static/image11.png))
...
**Şekil 6**: sıralama ve disk belleği düzenlemek için GridView desteğini etkinleştir ([tam boyutlu görüntüyü görmek için tıklatın](caching-data-with-the-objectdatasource-cs/_static/image14.png))
...
**Şekil 7**: her ürün s ad, kategori ve fiyat sıralanabilir, Pageable, düzenlenebilir GridView listelenir ([tam boyutlu görüntüyü görmek için tıklatın](caching-data-with-the-objectdatasource-cs/_static/image17.png))
...
**Şekil 8**: sayfa yukarıda GridView için bir etiket ve düğme ekleyin ([tam boyutlu görüntüyü görmek için tıklatın](caching-data-with-the-objectdatasource-cs/_static/image20.png))
...
**Şekil 9**: her GridView kendi veri kaynağına DataSet'e, seçme olay harekete görüntülenir ([tam boyutlu görüntüyü görmek için tıklatın](caching-data-with-the-objectdatasource-cs/_static/image23.png))
...
**Şekil 11**: 30 saniye, verileri önbelleğe almak için ObjectDataSource yapılandırın ([tam boyutlu görüntüyü görmek için tıklatın](caching-data-with-the-objectdatasource-cs/_static/image29.png))
