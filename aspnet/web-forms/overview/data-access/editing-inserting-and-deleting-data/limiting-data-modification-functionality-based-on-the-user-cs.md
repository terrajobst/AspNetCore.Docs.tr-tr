...
ms.locfileid: "37372248"
---
<a name="limiting-data-modification-functionality-based-on-the-user-c"></a>Kullanıcıya (C#) bağlı veri değişikliği işlevselliğini sınırlama
====================
...
**Şekil 1**: bir kullanıcı bilgileri Mız şirket olabilir Düzenle herhangi tedarikçi s ([tam boyutlu görüntüyü görmek için tıklatın](limiting-data-modification-functionality-based-on-the-user-cs/_static/image3.png))
...
**Şekil 2**: bir kullanıcı bir belirli tedarikçi olabilir yalnızca görünümü ve düzenleme bilgilerine ([tam boyutlu görüntüyü görmek için tıklatın](limiting-data-modification-functionality-based-on-the-user-cs/_static/image6.png))
...
**Şekil 6**: Any tedarikçileri bilgileri görüntülenebilir ve kendi adres güncelleştirildi ([tam boyutlu görüntüyü görmek için tıklatın](limiting-data-modification-functionality-based-on-the-user-cs/_static/image18.png))
...
**Şekil 13**: seçili sağlayıcı tarafından sağlanan ürünleri görüntülenir ([tam boyutlu görüntüyü görmek için tıklatın](limiting-data-modification-functionality-based-on-the-user-cs/_static/image39.png))
...
**Şekil 14**: Chef Acı s Baharat karışımı Düzenle düğmesi gizlenir tedarikçi özgü kullanıcı ([tam boyutlu görüntüyü görmek için tıklatın](limiting-data-modification-functionality-based-on-the-user-cs/_static/image42.png))
...
**Şekil 15**: Göster/Düzenle tüm Üreticiler kullanıcıları için Chef Acı s Baharat karışımı görüntülenir için Düzenle düğmesini ([tam boyutlu görüntüyü görmek için tıklatın](limiting-data-modification-functionality-based-on-the-user-cs/_static/image45.png))
