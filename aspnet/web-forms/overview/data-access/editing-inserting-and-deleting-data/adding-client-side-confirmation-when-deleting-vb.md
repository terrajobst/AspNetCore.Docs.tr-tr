...
ms.locfileid: "37388273"
---
<a name="adding-client-side-confirmation-when-deleting-vb"></a>(VB) silerken istemci tarafı doğrulama ekleme
====================
...
**Şekil 3**: bir onay olan şimdi görüntülenen zaman tıklayarak Sil düğmesine ([tam boyutlu görüntüyü görmek için tıklatın](adding-client-side-confirmation-when-deleting-vb/_static/image7.png))


## <a name="step-3-configuring-the-onclientclick-property-for-the-delete-button-in-a-commandfield"></a>3. adım: bir CommandField Sil düğmesini OnClientClick özelliği yapılandırma
