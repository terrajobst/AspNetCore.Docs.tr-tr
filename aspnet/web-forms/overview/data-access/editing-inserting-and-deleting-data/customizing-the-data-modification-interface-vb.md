...
**Şekil 3**: gereksiz alanları GridView kaldırın ([tam boyutlu görüntüyü görmek için tıklatın](customizing-the-data-modification-interface-vb/_static/image9.png))
...
**Şekil 4**: GridView'ın salt okunur arabirimidir tamamlandı ([tam boyutlu görüntüyü görmek için tıklatın](customizing-the-data-modification-interface-vb/_static/image12.png))
...
**Şekil 9**: ilk öğesinde açılan listeler, varsayılan olarak seçilidir ([tam boyutlu görüntüyü görmek için tıklatın](customizing-the-data-modification-interface-vb/_static/image27.png))
...
**Şekil 11**: düzenlenebilir ürünün geçerli kategori ve tedarikçi değerleri varsayılan olarak seçilidir ([tam boyutlu görüntüyü görmek için tıklatın](customizing-the-data-modification-interface-vb/_static/image33.png))
...
**Şekil 13**: etkin ekleyin ve RadioButtonList kullanımdan seçenekleri ([tam boyutlu görüntüyü görmek için tıklatın](customizing-the-data-modification-interface-vb/_static/image39.png))
