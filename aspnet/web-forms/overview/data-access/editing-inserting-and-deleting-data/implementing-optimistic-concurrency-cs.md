...
**Şekil 1**: olduğunda iki kullanıcılar aynı anda güncelleştirme bir kaydı var. s olası bir kullanıcıyı değiştirir üzerine yaz diğer s ([tam boyutlu görüntüyü görmek için tıklatın](implementing-optimistic-concurrency-cs/_static/image3.png))
...
**Şekil 2**: For Update veya Delete Succeed, özgün değer gerekir olması eşit geçerli veritabanı değerlerini ([tam boyutlu görüntüyü görmek için tıklatın](implementing-optimistic-concurrency-cs/_static/image6.png))
...
## <a name="step-2-creating-a-data-access-layer-that-supports-optimistic-concurrency"></a>2. adım: iyimser eşzamanlılık destekleyen veri erişim katmanını oluşturma
...
**Şekil 5**: gelen aynı SQL sorgusu kullanmanın `Products` özgün DAL, TableAdapter ([tam boyutlu görüntüyü görmek için tıklatın](implementing-optimistic-concurrency-cs/_static/image15.png))
...
**Şekil 6**: etkinleştirme iyimser eşzamanlılık "iyimser eşzamanlılık kullan" onay kutusunu işaretleyerek denetimi ([tam boyutlu görüntüyü görmek için tıklatın](implementing-optimistic-concurrency-cs/_static/image18.png))
...
**Şekil 11**: yöntemlere Yeniden Adlandır `FillByProductID` ve `GetProductByProductID` ([tam boyutlu görüntüyü görmek için tıklatın](implementing-optimistic-concurrency-cs/_static/image33.png))
...
## <a name="step-4-passing-the-original-and-new-values-from-the-aspnet-page-to-the-bll-methods"></a>4. adım: özgün ve yeni değerleri ASP.NET sayfasında BLL yöntemlere geçirirken
...
**Şekil 14**: ürünleri GridView içinde listelenir ([tam boyutlu görüntüyü görmek için tıklatın](implementing-optimistic-concurrency-cs/_static/image40.png))
...
## <a name="step-5-testing-the-optimistic-concurrency-support"></a>5. adım: iyimser eşzamanlılık destek test
...
**Şekil 18**: iki etiket denetimleri eklenmiş sayfa ([tam boyutlu görüntüyü görmek için tıklatın](implementing-optimistic-concurrency-cs/_static/image52.png))
...
**Şekil 19**: bir kullanıcı s güncelleştirmeleri eşzamanlılık ihlalinin karşılaştıkları kaybolur ([tam boyutlu görüntüyü görmek için tıklatın](implementing-optimistic-concurrency-cs/_static/image55.png))
...
**Şekil 20**: bir kullanıcı s eşzamanlılık ihlalinin karşılaşıldığında silme iptal edildi ([tam boyutlu görüntüyü görmek için tıklatın](implementing-optimistic-concurrency-cs/_static/image58.png))
