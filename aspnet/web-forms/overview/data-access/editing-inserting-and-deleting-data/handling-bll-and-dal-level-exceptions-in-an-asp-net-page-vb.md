...
ms.locfileid: "37394689"
---
<a name="handling-bll--and-dal-level-exceptions-in-an-aspnet-page-vb"></a>(VB) bir ASP.NET sayfasında BLL ve DAL düzeyi özel durumları işleme
====================
...
**Şekil 4**: kaldırma dışındaki tüm gerekli BoundFields ve onay düzenlemeyi etkinleştir onay ([tam boyutlu görüntüyü görmek için tıklatın](handling-bll-and-dal-level-exceptions-in-an-asp-net-page-vb/_static/image12.png))
...
**Şekil 7**: sayfasına bir etiket Web denetim ekleme ([tam boyutlu görüntüyü görmek için tıklatın](handling-bll-and-dal-level-exceptions-in-an-asp-net-page-vb/_static/image21.png))
