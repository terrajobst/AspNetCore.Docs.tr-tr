...
ms.locfileid: "37402973"
---
<a name="creating-a-data-access-layer-vb"></a>(VB) veri erişim katmanını oluşturma
====================
...
**Şekil 3**: tüm veri erişim kodu DAL ile gönderilen ([tam boyutlu görüntüyü görmek için tıklatın](creating-a-data-access-layer-vb/_static/image7.png))
...
**Şekil 4**: yeni bir veri kümesi için projenize eklemek seçin ([tam boyutlu görüntüyü görmek için tıklatın](creating-a-data-access-layer-vb/_static/image10.png))
...
**Şekil 5**: Northwind veritabanına aşağı açılan listeden seçin ([tam boyutlu görüntüyü görmek için tıklatın](creating-a-data-access-layer-vb/_static/image13.png))
...
**Şekil 19**: Bu İçecekler kategorisindeki ürünlerin ait gösterilir ([tam boyutlu görüntüyü görmek için tıklatın](creating-a-data-access-layer-vb/_static/image51.png))
...
**Şekil 20**: Bu ürünleri İçecekler kategorisindeki görüntülenir ([tam boyutlu görüntüyü görmek için tıklatın](creating-a-data-access-layer-vb/_static/image54.png))
...
**Şekil 21**: her ekleme, güncelleştirme ve silme isteği gönderildi veritabanı anında ([tam boyutlu görüntüyü görmek için tıklatın](creating-a-data-access-layer-vb/_static/image57.png))
...
**Şekil 22**: güncelleştirme yöntemi çağrıldığında, tüm değişiklikleri veritabanı ile senkronize edilir ([tam boyutlu görüntüyü görmek için tıklatın](creating-a-data-access-layer-vb/_static/image60.png))
...
**Şekil 26**: Sorgu dönmek büyütmek `SCOPE_IDENTITY()` değeri ([tam boyutlu görüntüyü görmek için tıklatın](creating-a-data-access-layer-vb/_static/image72.png))
