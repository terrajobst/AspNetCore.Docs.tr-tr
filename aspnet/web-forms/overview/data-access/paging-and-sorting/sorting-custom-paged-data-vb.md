...
title: Özel sıralama disk belleğine alınan verileri (VB) | Microsoft Docs
...
---
<a name="sorting-custom-paged-data-vb"></a>Özel sıralama verileri (VB) disk belleği
====================
tarafından [Scott Mitchell](https://twitter.com/ScottOnWriting)

[Örnek uygulamayı indirin](http://download.microsoft.com/download/9/c/1/9c1d03ee-29ba-4d58-aa1a-f201dcc822ea/ASPNET_Data_Tutorial_26_VB.exe) veya [PDF indirin](sorting-custom-paged-data-vb/_static/datatutorial26vb1.pdf)
...
[![Saklı yordam s çıkış penceresinde sonuçlar gösterilir](sorting-custom-paged-data-vb/_static/image3.png)](sorting-custom-paged-data-vb/_static/image2.png)

**Şekil 2**: saklı yordam s sonuçları çıktı penceresinde gösterilir ([tam boyutlu görüntüyü görüntülemek için tıklatın](sorting-custom-paged-data-vb/_static/image4.png))
...
![Varolan bir saklı yordamı kullanmak için seçin](sorting-custom-paged-data-vb/_static/image5.png)
...
![GetProductsPagedAndSorted kullanmak saklı yordamı](sorting-custom-paged-data-vb/_static/image6.png)
...
**Şekil 7**: sonuçları UnitPrice göre sıralanır ([tam boyutlu görüntüyü görüntülemek için tıklatın](sorting-custom-paged-data-vb/_static/image11.png))
...
![Sonuçları şu çalışma zamanı özel tedarikçi sonuçlarında göre sıralamak çalışılıyor](sorting-custom-paged-data-vb/_static/image12.png)
...
![Üretici BoundField s SortExpression ŞirketAdı için değiştirme](sorting-custom-paged-data-vb/_static/image13.png)

**Şekil 9**: üretici BoundField s SortExpression ŞirketAdı için değiştirme


[![Sonuçları şimdi tedarikçi tarafından sıralanabilir](sorting-custom-paged-data-vb/_static/image15.png)](sorting-custom-paged-data-vb/_static/image14.png)

**Şekil 10**: sonuçları şimdi sıralanıp sıralanamayacağını tedarikçi tarafından ([tam boyutlu görüntüyü görüntülemek için tıklatın](sorting-custom-paged-data-vb/_static/image16.png))
...
> [sonraki](creating-a-customized-sorting-user-interface-vb.md)
