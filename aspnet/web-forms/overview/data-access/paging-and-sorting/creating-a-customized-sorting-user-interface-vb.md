...
**Şekil 1**: her kategori grubu olduğunu açıkça tanımlanmış ([tam boyutlu görüntüyü görmek için tıklatın](creating-a-customized-sorting-user-interface-vb/_static/image3.png))
...
**Şekil 2**: veri kategoriye göre sıralandığına sıralanabilir GridView s ([tam boyutlu görüntüyü görmek için tıklatın](creating-a-customized-sorting-user-interface-vb/_static/image6.png))
...
**Şekil 4**: GridView s denetim hiyerarşisi alternatif bir yöntem yönetir ([tam boyutlu görüntüyü görmek için tıklatın](creating-a-customized-sorting-user-interface-vb/_static/image10.png))
...
**Şekil 6**: sıralama Grup üstbilgilerinde olan eksik sıralama bir CheckBoxField ([tam boyutlu görüntüyü görmek için tıklatın](creating-a-customized-sorting-user-interface-vb/_static/image16.png))
...
**Şekil 7**: sıralama grubu üst bilgilerdir artık mevcut sıralama bir CheckBoxField ([tam boyutlu görüntüyü görmek için tıklatın](creating-a-customized-sorting-user-interface-vb/_static/image19.png))
