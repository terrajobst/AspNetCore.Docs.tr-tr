...
- Veritabanı rol üyeliklerini Test ortamları için dağıtma. Her dağıtım & #x 2014; Örneğin, bir sürekli tümleştirme (CI) yapı bir parçası olarak bir veritabanı oluşturun ve bir test ortamı & #x 2014; dağıtırken genellikle her veritabanı rol üyeliklerini yapılandırmanız gerekir. Örneğin, genellikle web uygulamasıyla ilişkilendirilmiş uygulama havuzu kimliği izinleri gerekecektir. Bu konuda, bir dağıtım sonrası SQL betiği dağıtım mantığınızı ekleyerek bu işlemi nasıl otomatikleştirebilirsiniz açıklanmaktadır.
