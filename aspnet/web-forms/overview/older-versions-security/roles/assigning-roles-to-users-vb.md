...
ms.locfileid: "37397055"
---
<a name="assigning-roles-to-users-vb"></a>(VB) kullanıcılara rol atama
====================
...
**Şekil 2**: Kullanıcıları ve rolleri sayfası görüntüler ([tam boyutlu görüntüyü görmek için tıklatın](assigning-roles-to-users-vb/_static/image6.png))
...
**Şekil 5**: roller görüntülenir `RoleList` DropDownList ([tam boyutlu görüntüyü görmek için tıklatın](assigning-roles-to-users-vb/_static/image15.png))
...
**Şekil 7**: GridView için "Kaldır" düğmesi ekleyin ([tam boyutlu görüntüyü görmek için tıklatın](assigning-roles-to-users-vb/_static/image21.png))
...
**Şekil 9**: rol varolmayan kullanıcı eklenemiyor ([tam boyutlu görüntüyü görmek için tıklatın](assigning-roles-to-users-vb/_static/image27.png))
...
**Şekil 10**: Tito olduğunu bir kez daha bir yönetici!  ([Tam boyutlu görüntüyü görmek için tıklatın](assigning-roles-to-users-vb/_static/image30.png))
...
## <a name="step-4-customizing-the-createuserwizard-to-include-a-specify-roles-step"></a>4. adım: bir "Rollerini belirtin" adımı eklemek için CreateUserWizard özelleştirme
...
İleri'ye tıklama neden bir geri gönderme ve güncelleştirmeleri `ActiveStep` "Tamamlandı" adıma. İçinde `ActiveStepChanged` olay işleyicisi, son oluşturulan kullanıcı hesabını denetçiler rolüne atanır. Bunu doğrulamak için iade `UsersAndRoles.aspx` sayfasında ve gelen denetçiler seçin `RoleList` DropDownList. Şekil 14 gösterildiği gibi denetçilere artık üç kullanıcıları oluşur: Bruce Tito ve Wanda.
