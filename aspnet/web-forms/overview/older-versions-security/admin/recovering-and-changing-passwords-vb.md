...
ms.locfileid: "37822920"
---
<a name="recovering-and-changing-passwords-vb"></a>(VB) parolaları kurtarma ve değiştirme
====================
...
## <a name="step-1-helping-users-recover-lost-passwords"></a>1. adım: Parola kayıp yardımcı kullanıcılar Kurtar
...
**Şekil 3**: geçersiz bir güvenlik yanıtı kullanıcının girdiği durumlarda bir hata iletisi görüntülenir ([tam boyutlu görüntüyü görmek için tıklatın](recovering-and-changing-passwords-vb/_static/image9.png))
...
## <a name="step-2-changing-passwords"></a>2. adım: Parola değiştirme
...
**Şekil 8**: bir e-posta iletisini bildirir, Their Parola değiştirildi ([tam boyutlu görüntüyü görmek için tıklatın](recovering-and-changing-passwords-vb/_static/image24.png))
