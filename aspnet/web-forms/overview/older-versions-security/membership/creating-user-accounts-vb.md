...
- [`CreateUserWizardStep`](https://msdn.microsoft.com/en-us/library/system.web.ui.webcontrols.createuserwizardstep.aspx) ? Yeni kullanıcı hesabı oluşturma hakkında bilgi toplamak için arabirimi işler. Bu, Şekil 11'de gösterilen adımdır.
