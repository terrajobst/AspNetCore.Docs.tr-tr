...
**Şekil 01**: formları kimlik doğrulama anahtarı'nın süre sonu olduğunda ilerlemiş bir grafik gösterimi false ([tam boyutlu görüntüyü görmek için tıklatın](forms-authentication-configuration-and-advanced-topics-cs/_static/image3.png))
...
**Şekil 02**: Forms kimlik doğrulaması bileti'nın bir grafik gösterimi ilerlemiş olduğunda true ([tam boyutlu görüntüyü görmek için tıklatın](forms-authentication-configuration-and-advanced-topics-cs/_static/image6.png))
...
**Şekil 03**: anahtar kimlik doğrulaması ile bir MAC sağlamış ([tam boyutlu görüntüyü görmek için tıklatın](forms-authentication-configuration-and-advanced-topics-cs/_static/image9.png))
...
**Şekil 06**: CustomIdentity ve CustomPrincipal sınıfları için projenize ekleyin ([tam boyutlu görüntüyü görmek için tıklatın](forms-authentication-configuration-and-advanced-topics-cs/_static/image18.png))
