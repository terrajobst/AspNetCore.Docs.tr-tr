...
**Şekil 03**: bir ana sayfa adlı Site.master Web sitesine ekleyin ([tam boyutlu görüntüyü görmek için tıklatın](an-overview-of-forms-authentication-vb/_static/image9.png))
...
**Şekil 07**: durumunda uygulamanızın proje mu değil henüz dahil Web.config, ekleme şimdi ([tam boyutlu görüntüyü görmek için tıklatın](an-overview-of-forms-authentication-vb/_static/image21.png))
...
**Şekil 10**: InvalidCredentialsMessage etiket olduğu görüntülenen girme geçersiz kimlik bilgilerini ([tam boyutlu görüntüyü görmek için tıklatın](an-overview-of-forms-authentication-vb/_static/image30.png))
...
**Şekil 11**: zaman ziyaret anonim olarak, bir günlük bağlantısını görüntülenir ([tam boyutlu görüntüyü görmek için tıklatın](an-overview-of-forms-authentication-vb/_static/image33.png))
...
**Şekil 12**: kimliği doğrulanmış kullanıcılar gösterilen yeniden Hoş Geldiniz! İleti ([tam boyutlu görüntüyü görmek için tıklatın](an-overview-of-forms-authentication-vb/_static/image36.png))
...
Başlangıç Gezinti içinde ana sayfasına LoginContent adlı bir ContentPlaceHolder ekleyerek &lt;div&gt; öğesi. Kaynak görünümü elde edilen biçimlendirme TODO üzerinde doğru yerleştirme araç kutusundan ContentPlaceHolder denetimi yalnızca sürükleyebilirsiniz: menü metni buraya yazılacak.
