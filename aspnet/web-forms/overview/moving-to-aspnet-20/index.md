...
====================
> ASP.NET 2.0 için ASP.NET 1.x uygulamaları geçirmek nasıl.


- [Visual Studio 2005'te geliştirmeleri](improvements-in-visual-studio-2005.md)
...
- [Veri bağlama denetimleri](data-bound-controls.md)
- [Önbelleğe alma](caching.md)
- [Üyelik](membership.md)
- [Yapılandırma ve izleme](configuration-and-instrumentation.md)
- [Profilleri, temalar ve Web Bölümleri](profiles-themes-and-web-parts.md)
