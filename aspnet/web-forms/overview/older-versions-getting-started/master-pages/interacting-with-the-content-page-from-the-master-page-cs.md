...
ms.locfileid: "37382601"
---
<a name="interacting-with-the-content-page-from-the-master-page-c"></a>İçerik sayfasından ana sayfa (C#) ile etkileşim kurma
====================
...
## <a name="step-1-displaying-products-in-a-content-page"></a>1. adım: Bir içerik sayfasındaki ürünleri görüntüleme
...
**Şekil 03**: Northwind veritabanına kullanılacak SqlDataSource yapılandırın ([tam boyutlu görüntüyü görmek için tıklatın](interacting-with-the-content-page-from-the-master-page-cs/_static/image9.png))
...
**Şekil 04**: iade `ProductName` ve `UnitPrice` alanlarını `Products` tablo ([tam boyutlu görüntüyü görmek için tıklatın](interacting-with-the-content-page-from-the-master-page-cs/_static/image12.png))


Tüm İşte bu kadar kolay! Sihirbazı tamamladıktan sonra Visual Studio iki BoundFields SqlDataSource denetimi tarafından döndürülen iki alan yansıtmak üzere GridView ekler. GridView ve SqlDataSource denetim biçimlendirme izler. Şekil 5 bir tarayıcıdan görüntülendiğinde sonuçları gösterilmektedir.
...
## <a name="step-2-adding-a-double-prices-button-to-the-master-page"></a>2. adım: ana sayfa için bir çift fiyatları düğme ekleme
...
**Şekil 07**: ayarlamak SqlDataSource'nın `UpdateCommand` özelliği ([tam boyutlu görüntüyü görmek için tıklatın](interacting-with-the-content-page-from-the-master-page-cs/_static/image21.png))
...
## <a name="step-3-raising-an-event-when-the-prices-are-doubled"></a>3. adım: bir olay olduğunda fiyatları yükseltme iki katına
...
## <a name="step-4-handling-the-event-in-the-content-page"></a>4. adım: içerik sayfası olayı işleme
...
**Şekil 08**: ilk fiyat değerleriyle ([tam boyutlu görüntüyü görmek için tıklatın](interacting-with-the-content-page-from-the-master-page-cs/_static/image24.png))
...
**Şekil 09**: The Just-Doubled fiyatları içinde GridViews görüntülenir ([tam boyutlu görüntüyü görmek için tıklatın](interacting-with-the-content-page-from-the-master-page-cs/_static/image27.png))
