...
title: Çekirdek IIS ve ASP.NET Geliştirme Sunucusu (VB) arasındaki farklar | Microsoft Docs
...
---
<a name="core-differences-between-iis-and-the-aspnet-development-server-vb"></a>IIS ve ASP.NET Geliştirme Sunucusu (VB) arasındaki temel farklar
====================
tarafından [Scott Mitchell](https://twitter.com/ScottOnWriting)

[Kodu indirme](http://download.microsoft.com/download/4/5/F/45F815EC-8B0E-46D3-9FB8-2DC015CCA306/ASPNET_Hosting_Tutorial_06_VB.zip) veya [PDF indirin](http://download.microsoft.com/download/E/8/9/E8920AE6-D441-41A7-8A77-9EF8FF970D8B/aspnet_tutorial06_WebServerDiff_vb.pdf)
...
[![Son tarih ve saat kitap gözden geçirme ziyaret metin dosyasını içerir&lt;](core-differences-between-iis-and-the-asp-net-development-server-vb/_static/image2.png)](core-differences-between-iis-and-the-asp-net-development-server-vb/_static/image1.png)

**Şekil 1**: metin dosyası son tarih ve saat kitap gözden geçirme ziyaret içerir ([tam boyutlu görüntüyü görüntülemek için tıklatın](core-differences-between-iis-and-the-asp-net-development-server-vb/_static/image3.png))
...
**Şekil 2**: varsayılan makine hesabı tarafından kullanılan IIS mu değil izinleri dosya sistemine yazma ([tam boyutlu görüntüyü görüntülemek için tıklatın](core-differences-between-iis-and-the-asp-net-development-server-vb/_static/image6.png))
...
Son olarak, ı web uygulamayı Web.config dosyasının kök dizininde güncelleştirerek form tabanlı kimlik doğrulaması kullanacak şekilde yapılandırılmış değiştirme:
...
[![Yetkisiz kullanıcıların otomatik olarak yeniden yönlendirilen oturum açma sayfası olan](core-differences-between-iis-and-the-asp-net-development-server-vb/_static/image8.png)](core-differences-between-iis-and-the-asp-net-development-server-vb/_static/image7.png)

**Şekil 3**: yetkisiz kullanıcıların olan otomatik olarak yeniden yönlendirilen oturum açma sayfası ([tam boyutlu görüntüyü görüntülemek için tıklatın](core-differences-between-iis-and-the-asp-net-development-server-vb/_static/image9.png))
...
[![Anonim kullanıcılar dosyaya doğrudan URL'yi girerek özel PDF dosyalarını indirebilirsiniz](core-differences-between-iis-and-the-asp-net-development-server-vb/_static/image11.png)](core-differences-between-iis-and-the-asp-net-development-server-vb/_static/image10.png)

**Şekil 4**: anonim kullanıcılar indirebilir özel PDF dosyaları tarafından girme doğrudan URL dosyasına ([tam boyutlu görüntüyü görüntülemek için tıklatın](core-differences-between-iis-and-the-asp-net-development-server-vb/_static/image12.png))
...
> [sonraki](deploying-a-database-vb.md)
