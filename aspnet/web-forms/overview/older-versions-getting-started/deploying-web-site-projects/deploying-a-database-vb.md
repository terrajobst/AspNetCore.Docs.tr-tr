...
ms.locfileid: "41753846"
---
<a name="deploying-a-database-vb"></a>Dağıtma (VB)
====================
...
**Şekil 3**: gözden geçirilmek üzere *öğretin kendiniz ASP.NET 3.5 24 saat içindeki* ([tam boyutlu görüntüyü görmek için tıklatın](deploying-a-database-vb/_static/image9.jpg))
