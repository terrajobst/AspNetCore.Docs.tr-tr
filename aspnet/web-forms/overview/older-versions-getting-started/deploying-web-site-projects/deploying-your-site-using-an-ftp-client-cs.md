...
ms.locfileid: "37385333"
---
<a name="deploying-your-site-using-an-ftp-client-c"></a>Sitenizi FTP istemcisi (C#) kullanarak dağıtma
====================
...
**Şekil 2**: Kitap incelemeleri Site erişilebilir artık bir Internet bağlantısı olan herkes ([tam boyutlu görüntüyü görmek için tıklatın](deploying-your-site-using-an-ftp-client-cs/_static/image6.png))
