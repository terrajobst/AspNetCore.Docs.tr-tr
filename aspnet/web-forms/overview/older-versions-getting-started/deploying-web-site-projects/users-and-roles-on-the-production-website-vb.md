...
[PDF indirin](http://download.microsoft.com/download/5/C/5/5C57DB8C-5DEA-4B3A-92CA-4405544D313B/aspnet_tutorial16_CustomAWAT_vb.pdf)
...
ASP.NET içeren bir [Web sitesi yönetim aracı](https://msdn.microsoft.com/en-us/library/yy40ytx0.aspx) (WSAT) kolaylaştıran kullanıcı hesapları ve rolleri oluşturmak ve yönetmek için ve kullanıcı ve rol tabanlı yetkilendirme kurallarını belirtmek için. WSAT kullanmak için Çözüm Gezgini'nde, ASP.NET yapılandırması simgesine tıklayın veya Web sitesi veya proje menüsüne gidin ve ASP.NET yapılandırma seçeneğini seçin. Her iki yaklaşım bir web tarayıcısını başlatır ve gibi bir adresindeki WSAT işaret:`http://localhost:portNumber/asp.netwebadminfiles/default.aspx?applicationPhysicalPath=pathToApplication`
...
([Tam boyutlu görüntüyü görüntülemek için tıklatın](users-and-roles-on-the-production-website-vb/_static/image3.png))
...
([Tam boyutlu görüntüyü görüntülemek için tıklatın](users-and-roles-on-the-production-website-vb/_static/image6.png))
...
([Tam boyutlu görüntüyü görüntülemek için tıklatın](users-and-roles-on-the-production-website-vb/_static/image9.png))
...
([Tam boyutlu görüntüyü görüntülemek için tıklatın](users-and-roles-on-the-production-website-vb/_static/image12.png))
...
İçinde [ *bir Web sitesi, kullanan uygulama hizmetlerini yapılandırma* öğretici](configuring-a-website-that-uses-application-services-vb.md) bir sayfaya eklenen `Admin` adlı klasörü `CreateAccount.aspx`. Yönetici siteye yeni bir kullanıcı hesabı eklemek ve yeni oluşturulan kullanıcı yönetici rolde olup olmadığını belirtmek için bu sayfayı sağlar (bkz **Şekil 5**).
...
([Tam boyutlu görüntüyü görüntülemek için tıklatın](users-and-roles-on-the-production-website-vb/_static/image15.png))
