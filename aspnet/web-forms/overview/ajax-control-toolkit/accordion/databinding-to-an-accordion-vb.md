...
ms.locfileid: "30869299"
---
<a name="databinding-to-an-accordion-vb"></a>Veri bağlama için bir Accordion (VB)
====================
tarafından [Christian Wenz](https://github.com/wenz)

[Kodu indirme](http://download.microsoft.com/download/5/6/d/56d50cef-2011-4c8f-9891-7edc6dc57df9/Accordion1.vb.zip) veya [PDF indirin](http://download.microsoft.com/download/6/7/1/6718d452-ff89-4d3f-a90e-c74ec2d636a3/accordion1VB.pdf)
...
[![Veriler accordion, doğrudan veri kaynağından gelir](databinding-to-an-accordion-vb/_static/image2.png)](databinding-to-an-accordion-vb/_static/image1.png)

Veriler accordion, doğrudan veri kaynağından gelir ([tam boyutlu görüntüyü görüntülemek için tıklatın](databinding-to-an-accordion-vb/_static/image3.png))

> [!div class="step-by-step"]
> [Önceki](dynamically-adding-an-accordion-pane-cs.md)
> [sonraki](dynamically-adding-an-accordion-pane-vb.md)
