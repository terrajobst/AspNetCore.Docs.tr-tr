...
====================
> Bu öğretici MutuallyExclusiveCheckbox denetimi radyo düğmeleri gibi iş onay kutuları oluşturmak için nasıl kullanılacağını (birbirini dışlayan) gösterir, ancak tamamen temizlenebilir.


- [Birbirini dışlayan onay kutuları oluşturma (C#)](creating-mutually-exclusive-checkboxes-cs.md)
- [Birbirini dışlayan onay kutularını (VB) oluşturma](creating-mutually-exclusive-checkboxes-vb.md)
