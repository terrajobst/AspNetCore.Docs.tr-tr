...
<span data-ttu-id="ea539-103">[Önceki - model ekleme](adding-model.md)
[sonraki - denetleyici yöntemlerine ve görünümler](controller-methods-views.md)</span><span class="sxs-lookup"><span data-stu-id="ea539-103">[Previous - Add a model](adding-model.md)
