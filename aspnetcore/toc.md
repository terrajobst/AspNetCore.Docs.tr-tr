...
## [Tek Sayfalı Uygulamalar için AngularJS kullanma](xref:client-side/angular)
## [Tek Sayfalı Uygulamalar için JavaScriptServices kullanma](xref:client-side/spa-services)
...
### [React ile Redux proje şablonu](xref:spa/react-with-redux)
