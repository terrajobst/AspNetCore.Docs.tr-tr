...
* *Geçişler* klasörünü silin ve *migrationssql* öğesini geçişlerle yenidenadlandırın.
* Projeyi oluşturun.
...
* Uygulamayı çalıştırın, daha önce oluşturduğunuz tüm öğrenci kayıtlarını silin ve uygulamayı durdurun.
