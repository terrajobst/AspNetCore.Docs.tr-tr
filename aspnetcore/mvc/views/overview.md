...
Bu belgede ASP.NET Core MVC uygulamalarında kullanılan görünümler açıklanmaktadır. Razor sayfalarında daha fazla bilgi için bkz: [Razor sayfalarının giriş](xref:razor-pages/index).
