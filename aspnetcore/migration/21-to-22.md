...
.NET Core'u hedefleyen projeler kullanması gereken [TFM](/dotnet/standard/frameworks) büyüktür veya eşittir .NET Core 2.2 sürümü. Proje dosyasında güncelleştirme `<TargetFramework>` düğümün iç metni ile `netcoreapp2.2`:
