...
Proje dosyası içeriyorsa `<RuntimeFrameworkVersion>1.{sub-version}</RuntimeFrameworkVersion>`, bkz: [bu GitHub sorunu](https://github.com/aspnet/AspNetCore/issues/3221#issuecomment-413094268).
