...
`ConfigureKestrel`seçenekleri ile `AllowSynchronousIO` etkinleştirmenin yanı sıra, zaman uyumlu GÇ geçici bir risk azaltma olarak istek başına temelinde da geçersiz kılınabilir:
