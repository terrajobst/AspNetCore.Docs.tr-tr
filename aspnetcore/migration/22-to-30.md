...
* Ayarlama [hedef çerçeve adı (TFM)](/dotnet/standard/frameworks) için `netcoreapp3.0`:
...
3\. 0'çalışma zamanı derlemesi Tercihli bir senaryodur. Çalışma zamanı derlemesi etkinleştirmek için bkz: https://docs.microsoft.com/aspnet/core/mvc/views/view-compilation?view=aspnetcore-3.0#runtime-compilation.
