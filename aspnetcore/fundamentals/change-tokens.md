...
[Görüntüleme veya indirme örnek kodu](https://github.com/aspnet/AspNetCore.Docs/tree/master/aspnetcore/fundamentals/change-tokens/sample/) ([nasıl indirileceğini](xref:index#how-to-download-a-sample))
