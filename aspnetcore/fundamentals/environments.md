...
Bkz: *ortam değişkenlerini ayarlama* bölümünü [ASP.NET Core modül yapılandırma başvurusu](xref:hosting/aspnet-core-module#setting-environment-variables) konu.
