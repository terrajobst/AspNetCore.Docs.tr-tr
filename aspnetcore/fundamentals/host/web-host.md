...
* <span data-ttu-id="fa5fe-122">Yükleri uygulama yapılandırmasından:</span><span class="sxs-lookup"><span data-stu-id="fa5fe-122">Loads app configuration from:</span></span>
  ...
  * <span data-ttu-id="fa5fe-127">Komut satırı bağımsız değişkenleri.</span><span class="sxs-lookup"><span data-stu-id="fa5fe-127">Command-line arguments.</span></span>
...
<span data-ttu-id="fa5fe-151">Uygulama yapılandırması hakkında daha fazla bilgi için bkz. <xref:fundamentals/configuration/index>.</span><span class="sxs-lookup"><span data-stu-id="fa5fe-151">For more information on app configuration, see <xref:fundamentals/configuration/index>.</span></span>
...
<span data-ttu-id="fa5fe-205">**Anahtar**: contentRoot</span><span class="sxs-lookup"><span data-stu-id="fa5fe-205">**Key**: contentRoot</span></span>  
...
<span data-ttu-id="fa5fe-323">*hostsettings.JSON*:</span><span class="sxs-lookup"><span data-stu-id="fa5fe-323">*hostsettings.json*:</span></span>
...
<span data-ttu-id="fa5fe-344">**Başlangıç (RequestDelegate uygulaması)**</span><span class="sxs-lookup"><span data-stu-id="fa5fe-344">**Start(RequestDelegate app)**</span></span>
...
<span data-ttu-id="fa5fe-368">**StartWith (Eylem&lt;IApplicationBuilder&gt; uygulama)**</span><span class="sxs-lookup"><span data-stu-id="fa5fe-368">**StartWith(Action&lt;IApplicationBuilder&gt; app)**</span></span>
...
## <a name="iapplicationlifetime-interface"></a><span data-ttu-id="fa5fe-390">IApplicationLifetime arabirimi</span><span class="sxs-lookup"><span data-stu-id="fa5fe-390">IApplicationLifetime interface</span></span>
...
| <span data-ttu-id="fa5fe-393">İptal belirteci</span><span class="sxs-lookup"><span data-stu-id="fa5fe-393">Cancellation Token</span></span>    | <span data-ttu-id="fa5fe-394">Ne zaman tetiklenir&#8230;</span><span class="sxs-lookup"><span data-stu-id="fa5fe-394">Triggered when&#8230;</span></span> |
| --------------------- | --------------------- |
| [<span data-ttu-id="fa5fe-395">ApplicationStarted</span><span class="sxs-lookup"><span data-stu-id="fa5fe-395">ApplicationStarted</span></span>](/dotnet/api/microsoft.extensions.hosting.iapplicationlifetime.applicationstarted) | <span data-ttu-id="fa5fe-396">Ana bilgisayarın tam olarak başlatılmış.</span><span class="sxs-lookup"><span data-stu-id="fa5fe-396">The host has fully started.</span></span> |
| [<span data-ttu-id="fa5fe-397">ApplicationStopped</span><span class="sxs-lookup"><span data-stu-id="fa5fe-397">ApplicationStopped</span></span>](/dotnet/api/microsoft.extensions.hosting.iapplicationlifetime.applicationstopped) | <span data-ttu-id="fa5fe-398">Konak bir şekilde kapatılmasını tamamlıyor.</span><span class="sxs-lookup"><span data-stu-id="fa5fe-398">The host is completing a graceful shutdown.</span></span> <span data-ttu-id="fa5fe-399">Tüm isteklerin işlenmesi.</span><span class="sxs-lookup"><span data-stu-id="fa5fe-399">All requests should be processed.</span></span> <span data-ttu-id="fa5fe-400">Bu olay tamamlanıncaya kadar kapatma engeller.</span><span class="sxs-lookup"><span data-stu-id="fa5fe-400">Shutdown blocks until this event completes.</span></span> |
| [<span data-ttu-id="fa5fe-401">ApplicationStopping</span><span class="sxs-lookup"><span data-stu-id="fa5fe-401">ApplicationStopping</span></span>](/dotnet/api/microsoft.extensions.hosting.iapplicationlifetime.applicationstopping) | <span data-ttu-id="fa5fe-402">Konak bir şekilde kapatılmasını gerçekleştiriyor.</span><span class="sxs-lookup"><span data-stu-id="fa5fe-402">The host is performing a graceful shutdown.</span></span> <span data-ttu-id="fa5fe-403">İstekler hala işleniyor.</span><span class="sxs-lookup"><span data-stu-id="fa5fe-403">Requests may still be processing.</span></span> <span data-ttu-id="fa5fe-404">Bu olay tamamlanıncaya kadar kapatma engeller.</span><span class="sxs-lookup"><span data-stu-id="fa5fe-404">Shutdown blocks until this event completes.</span></span> |
...
<span data-ttu-id="fa5fe-405">[StopApplication](/dotnet/api/microsoft.aspnetcore.hosting.iapplicationlifetime.stopapplication) sonlandırma uygulamanın ister.</span><span class="sxs-lookup"><span data-stu-id="fa5fe-405">[StopApplication](/dotnet/api/microsoft.aspnetcore.hosting.iapplicationlifetime.stopapplication) requests termination of the app.</span></span> <span data-ttu-id="fa5fe-406">Aşağıdaki sınıf kullandığı `StopApplication` düzgün bir şekilde bir uygulamasını kapatmak için sınıfın `Shutdown` yöntemi çağrılır:</span><span class="sxs-lookup"><span data-stu-id="fa5fe-406">The following class uses `StopApplication` to gracefully shut down an app when the class's `Shutdown` method is called:</span></span>
...
## <a name="scope-validation"></a><span data-ttu-id="fa5fe-407">Kapsam doğrulama</span><span class="sxs-lookup"><span data-stu-id="fa5fe-407">Scope validation</span></span>

::: moniker range=">= aspnetcore-2.0"

<span data-ttu-id="fa5fe-408">[CreateDefaultBuilder](/dotnet/api/microsoft.aspnetcore.webhost.createdefaultbuilder) ayarlar [ServiceProviderOptions.ValidateScopes](/dotnet/api/microsoft.extensions.dependencyinjection.serviceprovideroptions.validatescopes) için `true` uygulamanın ortamı geliştirme ise.</span><span class="sxs-lookup"><span data-stu-id="fa5fe-408">[CreateDefaultBuilder](/dotnet/api/microsoft.aspnetcore.webhost.createdefaultbuilder) sets [ServiceProviderOptions.ValidateScopes](/dotnet/api/microsoft.extensions.dependencyinjection.serviceprovideroptions.validatescopes) to `true` if the app's environment is Development.</span></span>

::: moniker-end

<span data-ttu-id="fa5fe-409">Zaman `ValidateScopes` ayarlanır `true`, varsayılan hizmet sağlayıcısı, doğrulamak üzere denetler:</span><span class="sxs-lookup"><span data-stu-id="fa5fe-409">When `ValidateScopes` is set to `true`, the default service provider performs checks to verify that:</span></span>

* <span data-ttu-id="fa5fe-410">Kapsamlı Hizmetleri doğrudan veya dolaylı olarak kök hizmet sağlayıcısından çözülmüş değildir.</span><span class="sxs-lookup"><span data-stu-id="fa5fe-410">Scoped services aren't directly or indirectly resolved from the root service provider.</span></span>
* <span data-ttu-id="fa5fe-411">Kapsamlı Hizmetleri doğrudan veya dolaylı olarak teklileri eklenen değildir.</span><span class="sxs-lookup"><span data-stu-id="fa5fe-411">Scoped services aren't directly or indirectly injected into singletons.</span></span>

<span data-ttu-id="fa5fe-412">Kök hizmet sağlayıcısı oluşturulur [BuildServiceProvider](/dotnet/api/microsoft.extensions.dependencyinjection.servicecollectioncontainerbuilderextensions.buildserviceprovider) çağrılır.</span><span class="sxs-lookup"><span data-stu-id="fa5fe-412">The root service provider is created when [BuildServiceProvider](/dotnet/api/microsoft.extensions.dependencyinjection.servicecollectioncontainerbuilderextensions.buildserviceprovider) is called.</span></span> <span data-ttu-id="fa5fe-413">Kök hizmet sağlayıcısının bir ömür zaman sağlayıcısı uygulamayla başlar ve uygulama kapatıldığında atıldı uygulama/sunucusunun ömrü karşılık gelir.</span><span class="sxs-lookup"><span data-stu-id="fa5fe-413">The root service provider's lifetime corresponds to the app/server's lifetime when the provider starts with the app and is disposed when the app shuts down.</span></span>

<span data-ttu-id="fa5fe-414">Kapsamlı Hizmetleri, onları oluşturan kapsayıcı tarafından elden çıkarılmasını.</span><span class="sxs-lookup"><span data-stu-id="fa5fe-414">Scoped services are disposed by the container that created them.</span></span> <span data-ttu-id="fa5fe-415">Kapsamlı bir hizmet içinde kök kapsayıcı oluşturduysanız, uygulama/sunucu kapatıldığında yalnızca kök kapsayıcı tarafından bırakılmadan olduğundan hizmet ömrü tekliye etkili bir şekilde yükseltilir.</span><span class="sxs-lookup"><span data-stu-id="fa5fe-415">If a scoped service is created in the root container, the service's lifetime is effectively promoted to singleton because it's only disposed by the root container when app/server is shut down.</span></span> <span data-ttu-id="fa5fe-416">Hizmet kapsamları doğrulama yakalar bu gibi durumlarda, `BuildServiceProvider` çağrılır.</span><span class="sxs-lookup"><span data-stu-id="fa5fe-416">Validating service scopes catches these situations when `BuildServiceProvider` is called.</span></span>

<span data-ttu-id="fa5fe-417">Kapsamlar üretim ortamında dahil olmak üzere, her zaman doğrulamak için yapılandırma [ServiceProviderOptions](/dotnet/api/microsoft.extensions.dependencyinjection.serviceprovideroptions) ile [UseDefaultServiceProvider](/dotnet/api/microsoft.aspnetcore.hosting.webhostbuilderextensions.usedefaultserviceprovider) konak oluşturucu üzerinde:</span><span class="sxs-lookup"><span data-stu-id="fa5fe-417">To always validate scopes, including in the Production environment, configure the [ServiceProviderOptions](/dotnet/api/microsoft.extensions.dependencyinjection.serviceprovideroptions) with [UseDefaultServiceProvider](/dotnet/api/microsoft.aspnetcore.hosting.webhostbuilderextensions.usedefaultserviceprovider) on the host builder:</span></span>
...
## <a name="troubleshooting-systemargumentexception"></a><span data-ttu-id="fa5fe-418">System.ArgumentException sorunlarını giderme</span><span class="sxs-lookup"><span data-stu-id="fa5fe-418">Troubleshooting System.ArgumentException</span></span>

<span data-ttu-id="fa5fe-419">**Aşağıdaki uygulama çağırdığınızda değil, yalnızca ASP.NET Core 2.0 uygulamaları için geçerli `UseStartup` veya `Configure`.**</span><span class="sxs-lookup"><span data-stu-id="fa5fe-419">**The following only applies to ASP.NET Core 2.0 apps when the app doesn't call `UseStartup` or `Configure`.**</span></span>

<span data-ttu-id="fa5fe-420">Bir konak ekleyerek oluşturulabilir `IStartup` doğrudan çağırmak yerine bağımlılık ekleme kapsayıcısını `UseStartup` veya `Configure`:</span><span class="sxs-lookup"><span data-stu-id="fa5fe-420">A host may be built by injecting `IStartup` directly into the dependency injection container rather than calling `UseStartup` or `Configure`:</span></span>

```csharp
services.AddSingleton<IStartup, Startup>();
```

<span data-ttu-id="fa5fe-421">Bu şekilde konak oluşturulursa, şu hata ortaya çıkabilir:</span><span class="sxs-lookup"><span data-stu-id="fa5fe-421">If the host is built this way, the following error may occur:</span></span>

```
Unhandled Exception: System.ArgumentException: A valid non-empty application name must be provided.
```

<span data-ttu-id="fa5fe-422">Uygulama adı (geçerli derleme adı) taraması gereklidir çünkü böyle `HostingStartupAttributes`.</span><span class="sxs-lookup"><span data-stu-id="fa5fe-422">This occurs because the app name (the name of the current assembly) is required to scan for `HostingStartupAttributes`.</span></span> <span data-ttu-id="fa5fe-423">Uygulamayı el ile ekler, `IStartup` bağımlılık ekleme kapsayıcısına eklemek için aşağıdaki çağrıyı `WebHostBuilder` ile belirtilen derleme adı:</span><span class="sxs-lookup"><span data-stu-id="fa5fe-423">If the app manually injects `IStartup` into the dependency injection container, add the following call to `WebHostBuilder` with the assembly name specified:</span></span>
...
<span data-ttu-id="fa5fe-424">Alternatif olarak, bir kukla eklenmesini `Configure` için `WebHostBuilder`, otomatik olarak uygulama adını ayarlar:</span><span class="sxs-lookup"><span data-stu-id="fa5fe-424">Alternatively, add a dummy `Configure` to the `WebHostBuilder`, which sets the app name automatically:</span></span>
...
<span data-ttu-id="fa5fe-425">Daha fazla bilgi için [duyuruları: Microsoft.Extensions.PlatformAbstractions geldi (Açıklama) kaldırıldı](https://github.com/aspnet/Announcements/issues/237#issuecomment-323786938) ve [StartupInjection örnek](https://github.com/aspnet/Hosting/blob/8377d226f1e6e1a97dabdb6769a845eeccc829ed/samples/SampleStartups/StartupInjection.cs).</span><span class="sxs-lookup"><span data-stu-id="fa5fe-425">For more information, see [Announcements: Microsoft.Extensions.PlatformAbstractions has been removed (comment)](https://github.com/aspnet/Announcements/issues/237#issuecomment-323786938) and the [StartupInjection sample](https://github.com/aspnet/Hosting/blob/8377d226f1e6e1a97dabdb6769a845eeccc829ed/samples/SampleStartups/StartupInjection.cs).</span></span>

::: moniker-end

## <a name="additional-resources"></a><span data-ttu-id="fa5fe-426">Ek kaynaklar</span><span class="sxs-lookup"><span data-stu-id="fa5fe-426">Additional resources</span></span>
