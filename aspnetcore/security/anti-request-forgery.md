...
> [!NOTE]
> [Razor sayfalarının](xref:razor-pages/index) XSRF/CSRF otomatik olarak korunur. Daha fazla bilgi için bkz: [XSRF/CSRF ve Razor sayfalarının](xref:razor-pages/index#xsrf).
