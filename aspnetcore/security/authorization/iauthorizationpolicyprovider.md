...
Uygulamanın [bağımlılık ekleme](xref:fundamentals/dependency-injection) kapsayıcısına farklı bir `IAuthorizationPolicyProvider` uygulaması kaydederek bu davranışı özelleştirebilirsiniz. 
