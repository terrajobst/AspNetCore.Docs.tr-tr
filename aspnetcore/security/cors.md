...
Bu bölümde, HTTP iletileri düzeyinde bir CORS istek olanlar açıklanmaktadır. CORS ilkesini doğru şekilde yapılandırmanız ve beklediğiniz gibi şeyler çalışmazsa sorun giderme nasıl CORS, çalışır, böylece anlamak önemlidir.
...
Çıkış noktaları arası istek bir örneği burada verilmiştir. "Kaynak" başlığı istekte sitenin etki alanını verir:
