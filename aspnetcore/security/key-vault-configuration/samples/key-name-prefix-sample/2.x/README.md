# <a name="prefix-key-vault-configuration-provider-sample-application-aspnet-core-2x"></a>Anahtar kasası yapılandırma sağlayıcısı örnek uygulama önek (ASP.NET Core 2.x)
