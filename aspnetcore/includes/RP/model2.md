...
Aşağıdakileri ekleyin `DbContext` türetilmiş sınıf adlı *MovieContext.cs* için *modelleri* klasörü: [!code-csharp[](../../tutorials/razor-pages/razor-pages-start/snapshot_sample/RazorPagesMovie/Models/MovieContext.cs)]
