<span data-ttu-id="a3f42-101">Aşağıdaki özellikleri `Movie` sınıfı:</span><span class="sxs-lookup"><span data-stu-id="a3f42-101">Add the following properties to the `Movie` class:</span></span>
