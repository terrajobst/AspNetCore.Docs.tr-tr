<span data-ttu-id="ba32d-101">Aşağıdaki özellikleri `Movie` sınıfı:</span><span class="sxs-lookup"><span data-stu-id="ba32d-101">Add the following properties to the `Movie` class:</span></span>
