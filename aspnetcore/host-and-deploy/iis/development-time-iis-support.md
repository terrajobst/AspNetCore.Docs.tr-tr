...
Bu makalede [Visual Studio](https://www.visualstudio.com/vs/) IIS ile Windows Server üzerinde çalışan ASP.NET Core uygulamalarında hata ayıklama için destek. Bu konuda bu senaryoyu etkinleştirmek ve bir proje ayarlama gösterilmektedir.
...
* [HTTPS'yi zorunlu tutma](xref:security/enforcing-ssl)
