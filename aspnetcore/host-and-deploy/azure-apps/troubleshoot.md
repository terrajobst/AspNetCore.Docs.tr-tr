...
* IIS de kullanır [ASP.NET Core Modülü](xref:host-and-deploy/aspnet-core-module) ana bilgisayar uygulamaları için. Sorun giderme özellikle IIS ile ilgili öneriler için bkz: <xref:host-and-deploy/iis/troubleshoot>.
