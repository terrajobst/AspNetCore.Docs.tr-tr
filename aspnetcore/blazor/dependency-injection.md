...
| `IJSRuntime` | Çağrıları gönderilen bir JavaScript çalışma zamanı örneğini temsil eder. Daha fazla bilgi için bkz. <xref:blazor/javascript-interop>. |
| `IUriHelper` | URI ve gezinti durumu (tekli) ile çalışmak için Yardımcıları içerir. |
