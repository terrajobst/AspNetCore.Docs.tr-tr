...
# [<a name="visual-studio-code--visual-studio-for-mac"></a>Visual Studio Code'u / Visual Studio Mac için](#tab/visual-studio-code+visual-studio-mac)
...
* Test **Oluştur** bağlantı. Veri göndermek ve girin.
