...
<span data-ttu-id="2f54c-103">[Önceki: bir model ekleme](xref:tutorials/razor-pages-vsc/model)
[sonraki: sayfaları güncelleştir](xref:tutorials/razor-pages-vsc/da1)</span><span class="sxs-lookup"><span data-stu-id="2f54c-103">[Previous: Adding a model](xref:tutorials/razor-pages-vsc/model)
