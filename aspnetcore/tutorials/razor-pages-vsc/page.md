...
Sonraki öğretici, SQLite ve veritabanı dengeli açıklanmaktadır.

> [!div class="step-by-step"]
> [Önceki: bir model ekleme](xref:tutorials/razor-pages-vsc/model)
> [sonraki: SQLite](xref:tutorials/razor-pages-vsc/sql)
