...
---
# <a name="adding-a-controller-to-a-aspnet-core-mvc-app-with-visual-studio-code"></a>Visual Studio Code ile ASP.NET Core MVC uygulaması için bir denetleyici ekleme

Tarafından [Rick Anderson](https://twitter.com/RickAndMSFT)

[!INCLUDE[adding-controller](../../includes/mvc-intro/adding-controller1.md)]

* İçinde **VS Code**seçin **EXPLORER** simgesine tıklayın ve sonra Denetim-(sağ tıklatma) **denetleyicileri > yeni dosya**
