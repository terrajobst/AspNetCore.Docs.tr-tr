...
## <a name="building-web-applications"></a>Web uygulamaları oluşturma
...
* [Yeoman ile proje oluşturma](../client-side/yeoman.md)
...
## <a name="building-web-apis"></a>Yapı web API'leri
...
* [ASP.NET Core Web API Yardım Swagger kullanarak sayfaları](web-api-help-pages-using-swagger.md)
* [Arka uç yerel mobil uygulamalar için web hizmetleri oluşturma](../mobile/native-mobile-backend.md)
...
* [Facebook, Google ve diğer dış sağlayıcılarını kullanarak kimlik doğrulamasını etkinleştirme](../security/authentication/social/index.md)
...
* [İstemci tarafı paketleri Bower ile yönetme](../client-side/bower.md)
* [Önyükleme güzel, yanıt veren siteleriyle oluşturma](../client-side/bootstrap.md)

## <a name="testing"></a>Sınama
* [.NET Core dotnet test kullanarak, birim sınama](https://docs.microsoft.com/dotnet/articles/core/testing/unit-testing-with-dotnet-test)

## <a name="publishing-and-deployment"></a>Yayımlama ve dağıtım
...
* [Sürekli dağıtım Azure Web uygulaması yayımlama](../publishing/azure-continuous-deployment.md)
