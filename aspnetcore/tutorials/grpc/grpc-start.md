...
* **Paket Yöneticisi konsol** penceresinde, *Grpcgreeterclient. csproj* dosyalarını içeren klasöre Dizin değiştirmek için `cd GrpcGreeterClient` çalıştırın.
* Aşağıdaki komutları çalıştırın:
