...
1. [Model bir Razor sayfalarının uygulamasına ekleme](xref:tutorials/razor-pages/model)
1. [İskeleli Razor Sayfaları](xref:tutorials/razor-pages/page)
1. [SQL Server LocalDB ile çalışma](xref:tutorials/razor-pages/sql)
...
1. [Dosyaları karşıya yükleme](xref:tutorials/razor-pages/uploading-files)
