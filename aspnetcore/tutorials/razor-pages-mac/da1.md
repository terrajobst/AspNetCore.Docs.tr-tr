...
> <span data-ttu-id="570f2-103">[Önceki: İş SQLlite ile](xref:tutorials/razor-pages-mac/sql)
> [Ekle arama](xref:tutorials/razor-pages-mac/search)</span><span class="sxs-lookup"><span data-stu-id="570f2-103">[Previous: Work with SQLlite](xref:tutorials/razor-pages-mac/sql)
