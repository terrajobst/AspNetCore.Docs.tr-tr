...
<span data-ttu-id="9721b-103">[Önceki: SQLlite ile çalışma](xref:tutorials/razor-pages-mac/sql)
[arama ekleme](xref:tutorials/razor-pages-mac/search)</span><span class="sxs-lookup"><span data-stu-id="9721b-103">[Previous: Working with SQLlite](xref:tutorials/razor-pages-mac/sql)
