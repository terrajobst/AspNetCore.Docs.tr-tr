...
<span data-ttu-id="fc9f1-103">[Önceki: bir model ekleme](xref:tutorials/razor-pages-mac/model)
[sonraki: sayfaları güncelleştir](xref:tutorials/razor-pages-mac/da1)</span><span class="sxs-lookup"><span data-stu-id="fc9f1-103">[Previous: Adding a model](xref:tutorials/razor-pages-mac/model)
