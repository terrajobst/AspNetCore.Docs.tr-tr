...
---
# <a name="adding-a-controller-to-an-aspnet-core-mvc-app-with-visual-studio-for-mac"></a>Mac için Visual Studio ile ASP.NET Core MVC uygulamasına bir denetleyicisi ekleme
