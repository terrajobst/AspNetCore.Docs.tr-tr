...
> <span data-ttu-id="7d6ff-103">[Önceki - arama ekleyin](search.md)
> [sonraki - doğrulama ekleme](validation.md)</span><span class="sxs-lookup"><span data-stu-id="7d6ff-103">[Previous - Add search](search.md)
